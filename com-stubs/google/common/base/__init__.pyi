...
class Functions:
    ...
    @classmethod
    @overload
    def forMap(cls, map: java.util.Map[_forMap_0__K, _forMap_0__V], v: _forMap_0__V) -> Function[_forMap_0__K, _forMap_0__V]: ...
    _forMap_1__K = _py_TypeVar('_forMap_1__K')  # <K>
    _forMap_1__V = _py_TypeVar('_forMap_1__V')  # <V>
    @classmethod
    @overload
    def forMap(cls, map: java.util.Map[_forMap_1__K, _forMap_1__V]) -> Function[_forMap_1__K, _forMap_1__V]: ...
...
class Joiner:
    ...
    @overload
    def appendTo(self, a: _appendTo_0__A, objectArray: _py_List[_py_Any]) -> _appendTo_0__A: ...
    _appendTo_1__A = _py_TypeVar('_appendTo_1__A', bound=java.lang.Appendable)  # <A>
    @overload
    def appendTo(self, a: _appendTo_1__A, iterator: java.util.Iterator[_py_Any]) -> _appendTo_1__A: ...
    _appendTo_2__A = _py_TypeVar('_appendTo_2__A', bound=java.lang.Appendable)  # <A>
    @overload
    def appendTo(self, a: _appendTo_2__A, iterable: java.lang.Iterable[_py_Any]) -> _appendTo_2__A: ...
    _appendTo_3__A = _py_TypeVar('_appendTo_3__A', bound=java.lang.Appendable)  # <A>
    @overload
    def appendTo(self, a: _appendTo_3__A, object: _py_Any, object2: _py_Any, objectArray: _py_List[_py_Any]) -> _appendTo_3__A: ...
    @overload
    ...
    class MapJoiner:
        ...
        _appendTo_2__A = _py_TypeVar('_appendTo_2__A', bound=java.lang.Appendable)  # <A>
        @overload
        def appendTo(self, a: _appendTo_2__A, iterable: java.lang.Iterable[java.util.Map.Entry[_py_Any, _py_Any]]) -> _appendTo_2__A: ...
        _appendTo_3__A = _py_TypeVar('_appendTo_3__A', bound=java.lang.Appendable)  # <A>
        @overload
        def appendTo(self, a: _appendTo_3__A, iterator: java.util.Iterator[java.util.Map.Entry[_py_Any, _py_Any]]) -> _appendTo_3__A: ...
        @overload
        ...
        _appendTo_5__A = _py_TypeVar('_appendTo_5__A', bound=java.lang.Appendable)  # <A>
        @overload
        def appendTo(self, a: _appendTo_5__A, map: java.util.Map[_py_Any, _py_Any]) -> _appendTo_5__A: ...
        @overload
...
class Optional(java.io.Serializable, _py_Generic[_Optional__T]):
    ...
    _toJavaUtil_0__T = _py_TypeVar('_toJavaUtil_0__T')  # <T>
    @classmethod
    @overload
    def toJavaUtil(cls, optional: 'Optional'[_toJavaUtil_0__T]) -> java.util.Optional[_toJavaUtil_0__T]: ...
    @overload
...
class Preconditions:
    ...
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_0__T, string: str, object: _py_Any, char: str) -> _checkNotNull_0__T: ...
    _checkNotNull_1__T = _py_TypeVar('_checkNotNull_1__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_1__T, string: str, object: _py_Any, long: int) -> _checkNotNull_1__T: ...
    _checkNotNull_2__T = _py_TypeVar('_checkNotNull_2__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_2__T, string: str, object: _py_Any, int: int) -> _checkNotNull_2__T: ...
    _checkNotNull_3__T = _py_TypeVar('_checkNotNull_3__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_3__T, string: str, long: int, object: _py_Any) -> _checkNotNull_3__T: ...
    _checkNotNull_4__T = _py_TypeVar('_checkNotNull_4__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_4__T, string: str, long: int, long2: int) -> _checkNotNull_4__T: ...
    _checkNotNull_5__T = _py_TypeVar('_checkNotNull_5__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_5__T, string: str, long: int, int: int) -> _checkNotNull_5__T: ...
    _checkNotNull_6__T = _py_TypeVar('_checkNotNull_6__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_6__T, string: str, int: int, object: _py_Any) -> _checkNotNull_6__T: ...
    _checkNotNull_7__T = _py_TypeVar('_checkNotNull_7__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_7__T, string: str, object: _py_Any) -> _checkNotNull_7__T: ...
    _checkNotNull_8__T = _py_TypeVar('_checkNotNull_8__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_8__T, string: str, long: int) -> _checkNotNull_8__T: ...
    _checkNotNull_9__T = _py_TypeVar('_checkNotNull_9__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_9__T, string: str, object: _py_Any, object2: _py_Any, object3: _py_Any, object4: _py_Any) -> _checkNotNull_9__T: ...
    _checkNotNull_10__T = _py_TypeVar('_checkNotNull_10__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_10__T, string: str, object: _py_Any, object2: _py_Any, object3: _py_Any) -> _checkNotNull_10__T: ...
    _checkNotNull_11__T = _py_TypeVar('_checkNotNull_11__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_11__T, string: str, object: _py_Any, object2: _py_Any) -> _checkNotNull_11__T: ...
    _checkNotNull_12__T = _py_TypeVar('_checkNotNull_12__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_12__T) -> _checkNotNull_12__T: ...
    _checkNotNull_13__T = _py_TypeVar('_checkNotNull_13__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_13__T, string: str, char: str, char2: str) -> _checkNotNull_13__T: ...
    _checkNotNull_14__T = _py_TypeVar('_checkNotNull_14__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_14__T, string: str, char: str, int: int) -> _checkNotNull_14__T: ...
    _checkNotNull_15__T = _py_TypeVar('_checkNotNull_15__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_15__T, string: str, char: str, long: int) -> _checkNotNull_15__T: ...
    _checkNotNull_16__T = _py_TypeVar('_checkNotNull_16__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_16__T, object: _py_Any) -> _checkNotNull_16__T: ...
    _checkNotNull_17__T = _py_TypeVar('_checkNotNull_17__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_17__T, string: str, objectArray: _py_List[_py_Any]) -> _checkNotNull_17__T: ...
    _checkNotNull_18__T = _py_TypeVar('_checkNotNull_18__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_18__T, string: str, char: str) -> _checkNotNull_18__T: ...
    _checkNotNull_19__T = _py_TypeVar('_checkNotNull_19__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_19__T, string: str, long: int, char: str) -> _checkNotNull_19__T: ...
    _checkNotNull_20__T = _py_TypeVar('_checkNotNull_20__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_20__T, string: str, int: int) -> _checkNotNull_20__T: ...
    _checkNotNull_21__T = _py_TypeVar('_checkNotNull_21__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_21__T, string: str, int: int, long: int) -> _checkNotNull_21__T: ...
    _checkNotNull_22__T = _py_TypeVar('_checkNotNull_22__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_22__T, string: str, int: int, int2: int) -> _checkNotNull_22__T: ...
    _checkNotNull_23__T = _py_TypeVar('_checkNotNull_23__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_23__T, string: str, int: int, char: str) -> _checkNotNull_23__T: ...
    _checkNotNull_24__T = _py_TypeVar('_checkNotNull_24__T')  # <T>
    @classmethod
    @overload
    def checkNotNull(cls, t: _checkNotNull_24__T, string: str, char: str, object: _py_Any) -> _checkNotNull_24__T: ...
    @classmethod
    @overload
...
class Throwables:
    ...
    _propagateIfPossible_0__X = _py_TypeVar('_propagateIfPossible_0__X', bound=java.lang.Throwable)  # <X>
    @classmethod
    @overload
    def propagateIfPossible(cls, throwable: java.lang.Throwable, class_: _py_Type[_propagateIfPossible_0__X]) -> None: ...
    @classmethod
    @overload
...
class Converter(Function[_Converter__A, _Converter__B], _py_Generic[_Converter__A, _Converter__B]):
    _andThen_0__C = _py_TypeVar('_andThen_0__C')  # <C>
    @overload
    def andThen(self, converter: 'Converter'[_Converter__B, _andThen_0__C]) -> 'Converter'[_Converter__A, _andThen_0__C]: ...
    _andThen_1__V = _py_TypeVar('_andThen_1__V')  # <V>
    @overload
    def andThen(self, function: java.util.function.Function[_py_Any, _andThen_1__V]) -> java.util.function.Function[_py_Any, _andThen_1__V]: ...
