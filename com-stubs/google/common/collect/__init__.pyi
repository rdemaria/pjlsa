...
class Collections2:
    ...
    _orderedPermutations_0__E = _py_TypeVar('_orderedPermutations_0__E')  # <E>
    @classmethod
    @overload
    def orderedPermutations(cls, iterable: java.lang.Iterable[_orderedPermutations_0__E], comparator: java.util.Comparator[_orderedPermutations_0__E]) -> java.util.Collection[java.util.List[_orderedPermutations_0__E]]: ...
    _orderedPermutations_1__E = _py_TypeVar('_orderedPermutations_1__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def orderedPermutations(cls, iterable: java.lang.Iterable[_orderedPermutations_1__E]) -> java.util.Collection[java.util.List[_orderedPermutations_1__E]]: ...
...
class CompactHashSet(java.util.AbstractSet[_CompactHashSet__E], java.io.Serializable, _py_Generic[_CompactHashSet__E]):
    ...
    @classmethod
    @overload
    def create(cls, collection: java.util.Collection[_create_0__E]) -> 'CompactHashSet'[_create_0__E]: ...
    _create_1__E = _py_TypeVar('_create_1__E')  # <E>
    @classmethod
    @overload
    def create(cls) -> 'CompactHashSet'[_create_1__E]: ...
    _create_2__E = _py_TypeVar('_create_2__E')  # <E>
    @classmethod
    @overload
    def create(cls, eArray: _py_List[_create_2__E]) -> 'CompactHashSet'[_create_2__E]: ...
...
class ComparisonChain:
    ...
    _compare_1__T = _py_TypeVar('_compare_1__T')  # <T>
    @overload
    def compare(self, t: _compare_1__T, t2: _compare_1__T, comparator: java.util.Comparator[_compare_1__T]) -> 'ComparisonChain': ...
    @overload
...
class FluentIterable(java.lang.Iterable[_FluentIterable__E], _py_Generic[_FluentIterable__E]):
    ...
    @classmethod
    @overload
    def concat(cls, iterable: java.lang.Iterable[_concat_0__T], iterable2: java.lang.Iterable[_concat_0__T], iterable3: java.lang.Iterable[_concat_0__T], iterable4: java.lang.Iterable[_concat_0__T]) -> 'FluentIterable'[_concat_0__T]: ...
    _concat_1__T = _py_TypeVar('_concat_1__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterable: java.lang.Iterable[java.lang.Iterable[_concat_1__T]]) -> 'FluentIterable'[_concat_1__T]: ...
    _concat_2__T = _py_TypeVar('_concat_2__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterableArray: _py_List[java.lang.Iterable[_concat_2__T]]) -> 'FluentIterable'[_concat_2__T]: ...
    _concat_3__T = _py_TypeVar('_concat_3__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterable: java.lang.Iterable[_concat_3__T], iterable2: java.lang.Iterable[_concat_3__T], iterable3: java.lang.Iterable[_concat_3__T]) -> 'FluentIterable'[_concat_3__T]: ...
    _concat_4__T = _py_TypeVar('_concat_4__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterable: java.lang.Iterable[_concat_4__T], iterable2: java.lang.Iterable[_concat_4__T]) -> 'FluentIterable'[_concat_4__T]: ...
    def contains(self, object: _py_Any) -> bool: ...
    ...
    @classmethod
    @overload
    def of(cls, e: _of_0__E, eArray: _py_List[_of_0__E]) -> 'FluentIterable'[_of_0__E]: ...
    _of_1__E = _py_TypeVar('_of_1__E')  # <E>
    @classmethod
    @overload
    def of(cls) -> 'FluentIterable'[_of_1__E]: ...
    def size(self) -> int: ...
...
class ImmutableMap(java.util.Map[_ImmutableMap__K, _ImmutableMap__V], java.io.Serializable, _py_Generic[_ImmutableMap__K, _ImmutableMap__V]):
    ...
    @classmethod
    @overload
    def of(cls, k: _of_1__K, v: _of_1__V, k2: _of_1__K, v2: _of_1__V, k3: _of_1__K, v3: _of_1__V, k4: _of_1__K, v4: _of_1__V) -> 'ImmutableMap'[_of_1__K, _of_1__V]: ...
    _of_2__K = _py_TypeVar('_of_2__K')  # <K>
    _of_2__V = _py_TypeVar('_of_2__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_2__K, v: _of_2__V, k2: _of_2__K, v2: _of_2__V, k3: _of_2__K, v3: _of_2__V, k4: _of_2__K, v4: _of_2__V, k5: _of_2__K, v5: _of_2__V) -> 'ImmutableMap'[_of_2__K, _of_2__V]: ...
    ...
    @classmethod
    @overload
    def of(cls, k: _of_4__K, v: _of_4__V) -> 'ImmutableMap'[_of_4__K, _of_4__V]: ...
    _of_5__K = _py_TypeVar('_of_5__K')  # <K>
    _of_5__V = _py_TypeVar('_of_5__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_5__K, v: _of_5__V, k2: _of_5__K, v2: _of_5__V) -> 'ImmutableMap'[_of_5__K, _of_5__V]: ...
    ...
    @classmethod
    @overload
    def toImmutableMap(cls, function: java.util.function.Function[_toImmutableMap_0__T, _toImmutableMap_0__K], function2: java.util.function.Function[_toImmutableMap_0__T, _toImmutableMap_0__V], binaryOperator: java.util.function.BinaryOperator[_toImmutableMap_0__V]) -> java.util.stream.Collector[_toImmutableMap_0__T, _py_Any, 'ImmutableMap'[_toImmutableMap_0__K, _toImmutableMap_0__V]]: ...
    ...
    @classmethod
    @overload
    def toImmutableMap(cls, function: java.util.function.Function[_toImmutableMap_1__T, _toImmutableMap_1__K], function2: java.util.function.Function[_toImmutableMap_1__T, _toImmutableMap_1__V]) -> java.util.stream.Collector[_toImmutableMap_1__T, _py_Any, 'ImmutableMap'[_toImmutableMap_1__K, _toImmutableMap_1__V]]: ...
    def toString(self) -> str: ...
    @overload
    def values(self) -> java.util.Collection: ...
    @overload
...
class Iterables:
    ...
    @classmethod
    @overload
    def concat(cls, iterableArray: _py_List[java.lang.Iterable[_concat_0__T]]) -> java.lang.Iterable[_concat_0__T]: ...
    _concat_1__T = _py_TypeVar('_concat_1__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterable: java.lang.Iterable[java.lang.Iterable[_concat_1__T]]) -> java.lang.Iterable[_concat_1__T]: ...
    _concat_2__T = _py_TypeVar('_concat_2__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterable: java.lang.Iterable[_concat_2__T], iterable2: java.lang.Iterable[_concat_2__T], iterable3: java.lang.Iterable[_concat_2__T], iterable4: java.lang.Iterable[_concat_2__T]) -> java.lang.Iterable[_concat_2__T]: ...
    _concat_3__T = _py_TypeVar('_concat_3__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterable: java.lang.Iterable[_concat_3__T], iterable2: java.lang.Iterable[_concat_3__T], iterable3: java.lang.Iterable[_concat_3__T]) -> java.lang.Iterable[_concat_3__T]: ...
    _concat_4__T = _py_TypeVar('_concat_4__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterable: java.lang.Iterable[_concat_4__T], iterable2: java.lang.Iterable[_concat_4__T]) -> java.lang.Iterable[_concat_4__T]: ...
    ...
    @classmethod
    @overload
    def cycle(cls, tArray: _py_List[_cycle_0__T]) -> java.lang.Iterable[_cycle_0__T]: ...
    _cycle_1__T = _py_TypeVar('_cycle_1__T')  # <T>
    @classmethod
    @overload
    def cycle(cls, iterable: java.lang.Iterable[_cycle_1__T]) -> java.lang.Iterable[_cycle_1__T]: ...
    @classmethod
...
class Iterators:
    ...
    @classmethod
    @overload
    def concat(cls, iterator: java.util.Iterator[_concat_0__T], iterator2: java.util.Iterator[_concat_0__T]) -> java.util.Iterator[_concat_0__T]: ...
    _concat_1__T = _py_TypeVar('_concat_1__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterator: java.util.Iterator[_concat_1__T], iterator2: java.util.Iterator[_concat_1__T], iterator3: java.util.Iterator[_concat_1__T]) -> java.util.Iterator[_concat_1__T]: ...
    _concat_2__T = _py_TypeVar('_concat_2__T')  # <T>
    @classmethod
    @overload
    def concat(cls, iterator: java.util.Iterator[java.util.Iterator[_concat_2__T]]) -> java.util.Iterator[_concat_2__T]: ...
    _concat_3__T = _py_TypeVar('_concat_3__T')  # <T>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def filter(cls, iterator: java.util.Iterator[_py_Any], class_: _py_Type[_filter_0__T]) -> 'UnmodifiableIterator'[_filter_0__T]: ...
    _filter_1__T = _py_TypeVar('_filter_1__T')  # <T>
    @classmethod
    @overload
    def filter(cls, iterator: java.util.Iterator[_filter_1__T], predicate: com.google.common.base.Predicate[_filter_1__T]) -> 'UnmodifiableIterator'[_filter_1__T]: ...
    _find_0__T = _py_TypeVar('_find_0__T')  # <T>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def peekingIterator(cls, iterator: java.util.Iterator[_peekingIterator_0__T]) -> 'PeekingIterator'[_peekingIterator_0__T]: ...
    _peekingIterator_1__T = _py_TypeVar('_peekingIterator_1__T')  # <T>
    @classmethod
    @overload
    def peekingIterator(cls, peekingIterator: 'PeekingIterator'[_peekingIterator_1__T]) -> 'PeekingIterator'[_peekingIterator_1__T]: ...
    @classmethod
...
class Lists:
    ...
    @classmethod
    @overload
    def asList(cls, e: _asList_0__E, eArray: _py_List[_asList_0__E]) -> java.util.List[_asList_0__E]: ...
    _asList_1__E = _py_TypeVar('_asList_1__E')  # <E>
    @classmethod
    @overload
    def asList(cls, e: _asList_1__E, e2: _asList_1__E, eArray: _py_List[_asList_1__E]) -> java.util.List[_asList_1__E]: ...
    ...
    @classmethod
    @overload
    def newArrayList(cls, eArray: _py_List[_newArrayList_1__E]) -> java.util.ArrayList[_newArrayList_1__E]: ...
    _newArrayList_2__E = _py_TypeVar('_newArrayList_2__E')  # <E>
    @classmethod
    @overload
    def newArrayList(cls, iterator: java.util.Iterator[_newArrayList_2__E]) -> java.util.ArrayList[_newArrayList_2__E]: ...
    _newArrayList_3__E = _py_TypeVar('_newArrayList_3__E')  # <E>
    @classmethod
    @overload
    def newArrayList(cls, iterable: java.lang.Iterable[_newArrayList_3__E]) -> java.util.ArrayList[_newArrayList_3__E]: ...
    ...
    @classmethod
    @overload
    def newLinkedList(cls, iterable: java.lang.Iterable[_newLinkedList_0__E]) -> java.util.LinkedList[_newLinkedList_0__E]: ...
    _newLinkedList_1__E = _py_TypeVar('_newLinkedList_1__E')  # <E>
    @classmethod
    @overload
    def newLinkedList(cls) -> java.util.LinkedList[_newLinkedList_1__E]: ...
    _partition__T = _py_TypeVar('_partition__T')  # <T>
    @classmethod
...
class Maps:
    ...
    @classmethod
    @overload
    def asMap(cls, sortedSet: java.util.SortedSet[_asMap_0__K], function: com.google.common.base.Function[_asMap_0__K, _asMap_0__V]) -> java.util.SortedMap[_asMap_0__K, _asMap_0__V]: ...
    ...
    @classmethod
    @overload
    def asMap(cls, set: java.util.Set[_asMap_2__K], function: com.google.common.base.Function[_asMap_2__K, _asMap_2__V]) -> java.util.Map[_asMap_2__K, _asMap_2__V]: ...
    _difference_0__K = _py_TypeVar('_difference_0__K')  # <K>
    _difference_0__V = _py_TypeVar('_difference_0__V')  # <V>
    @classmethod
    @overload
    def difference(cls, map: java.util.Map[_difference_0__K, _difference_0__V], map2: java.util.Map[_difference_0__K, _difference_0__V], equivalence: com.google.common.base.Equivalence[_difference_0__V]) -> MapDifference[_difference_0__K, _difference_0__V]: ...
    _difference_1__K = _py_TypeVar('_difference_1__K')  # <K>
    _difference_1__V = _py_TypeVar('_difference_1__V')  # <V>
    @classmethod
    @overload
    def difference(cls, sortedMap: java.util.SortedMap[_difference_1__K, _difference_1__V], map: java.util.Map[_difference_1__K, _difference_1__V]) -> 'SortedMapDifference'[_difference_1__K, _difference_1__V]: ...
    _difference_2__K = _py_TypeVar('_difference_2__K')  # <K>
    _difference_2__V = _py_TypeVar('_difference_2__V')  # <V>
    @classmethod
    @overload
    def difference(cls, map: java.util.Map[_difference_2__K, _difference_2__V], map2: java.util.Map[_difference_2__K, _difference_2__V]) -> MapDifference[_difference_2__K, _difference_2__V]: ...
    _filterEntries_0__K = _py_TypeVar('_filterEntries_0__K')  # <K>
    _filterEntries_0__V = _py_TypeVar('_filterEntries_0__V')  # <V>
    @classmethod
    @overload
    def filterEntries(cls, map: java.util.Map[_filterEntries_0__K, _filterEntries_0__V], predicate: com.google.common.base.Predicate[java.util.Map.Entry[_filterEntries_0__K, _filterEntries_0__V]]) -> java.util.Map[_filterEntries_0__K, _filterEntries_0__V]: ...
    _filterEntries_1__K = _py_TypeVar('_filterEntries_1__K')  # <K>
    _filterEntries_1__V = _py_TypeVar('_filterEntries_1__V')  # <V>
    @classmethod
    @overload
    def filterEntries(cls, biMap: BiMap[_filterEntries_1__K, _filterEntries_1__V], predicate: com.google.common.base.Predicate[java.util.Map.Entry[_filterEntries_1__K, _filterEntries_1__V]]) -> BiMap[_filterEntries_1__K, _filterEntries_1__V]: ...
    _filterEntries_2__K = _py_TypeVar('_filterEntries_2__K')  # <K>
    _filterEntries_2__V = _py_TypeVar('_filterEntries_2__V')  # <V>
    @classmethod
    @overload
    def filterEntries(cls, sortedMap: java.util.SortedMap[_filterEntries_2__K, _filterEntries_2__V], predicate: com.google.common.base.Predicate[java.util.Map.Entry[_filterEntries_2__K, _filterEntries_2__V]]) -> java.util.SortedMap[_filterEntries_2__K, _filterEntries_2__V]: ...
    _filterEntries_3__K = _py_TypeVar('_filterEntries_3__K')  # <K>
    _filterEntries_3__V = _py_TypeVar('_filterEntries_3__V')  # <V>
    @classmethod
    @overload
    def filterEntries(cls, navigableMap: java.util.NavigableMap[_filterEntries_3__K, _filterEntries_3__V], predicate: com.google.common.base.Predicate[java.util.Map.Entry[_filterEntries_3__K, _filterEntries_3__V]]) -> java.util.NavigableMap[_filterEntries_3__K, _filterEntries_3__V]: ...
    _filterKeys_0__K = _py_TypeVar('_filterKeys_0__K')  # <K>
    _filterKeys_0__V = _py_TypeVar('_filterKeys_0__V')  # <V>
    @classmethod
    @overload
    def filterKeys(cls, navigableMap: java.util.NavigableMap[_filterKeys_0__K, _filterKeys_0__V], predicate: com.google.common.base.Predicate[_filterKeys_0__K]) -> java.util.NavigableMap[_filterKeys_0__K, _filterKeys_0__V]: ...
    _filterKeys_1__K = _py_TypeVar('_filterKeys_1__K')  # <K>
    _filterKeys_1__V = _py_TypeVar('_filterKeys_1__V')  # <V>
    @classmethod
    @overload
    def filterKeys(cls, biMap: BiMap[_filterKeys_1__K, _filterKeys_1__V], predicate: com.google.common.base.Predicate[_filterKeys_1__K]) -> BiMap[_filterKeys_1__K, _filterKeys_1__V]: ...
    _filterKeys_2__K = _py_TypeVar('_filterKeys_2__K')  # <K>
    _filterKeys_2__V = _py_TypeVar('_filterKeys_2__V')  # <V>
    @classmethod
    @overload
    def filterKeys(cls, sortedMap: java.util.SortedMap[_filterKeys_2__K, _filterKeys_2__V], predicate: com.google.common.base.Predicate[_filterKeys_2__K]) -> java.util.SortedMap[_filterKeys_2__K, _filterKeys_2__V]: ...
    _filterKeys_3__K = _py_TypeVar('_filterKeys_3__K')  # <K>
    _filterKeys_3__V = _py_TypeVar('_filterKeys_3__V')  # <V>
    @classmethod
    @overload
    def filterKeys(cls, map: java.util.Map[_filterKeys_3__K, _filterKeys_3__V], predicate: com.google.common.base.Predicate[_filterKeys_3__K]) -> java.util.Map[_filterKeys_3__K, _filterKeys_3__V]: ...
    ...
    @classmethod
    @overload
    def filterValues(cls, navigableMap: java.util.NavigableMap[_filterValues_1__K, _filterValues_1__V], predicate: com.google.common.base.Predicate[_filterValues_1__V]) -> java.util.NavigableMap[_filterValues_1__K, _filterValues_1__V]: ...
    _filterValues_2__K = _py_TypeVar('_filterValues_2__K')  # <K>
    _filterValues_2__V = _py_TypeVar('_filterValues_2__V')  # <V>
    @classmethod
    @overload
    def filterValues(cls, map: java.util.Map[_filterValues_2__K, _filterValues_2__V], predicate: com.google.common.base.Predicate[_filterValues_2__V]) -> java.util.Map[_filterValues_2__K, _filterValues_2__V]: ...
    ...
    @classmethod
    @overload
    def newEnumMap(cls, map: java.util.Map[_newEnumMap_0__K, _newEnumMap_0__V]) -> java.util.EnumMap[_newEnumMap_0__K, _newEnumMap_0__V]: ...
    _newEnumMap_1__K = _py_TypeVar('_newEnumMap_1__K', bound=java.lang.Enum)  # <K>
    _newEnumMap_1__V = _py_TypeVar('_newEnumMap_1__V')  # <V>
    @classmethod
    @overload
    def newEnumMap(cls, class_: _py_Type[_newEnumMap_1__K]) -> java.util.EnumMap[_newEnumMap_1__K, _newEnumMap_1__V]: ...
    _newHashMap_0__K = _py_TypeVar('_newHashMap_0__K')  # <K>
    _newHashMap_0__V = _py_TypeVar('_newHashMap_0__V')  # <V>
    @classmethod
    @overload
    def newHashMap(cls, map: java.util.Map[_newHashMap_0__K, _newHashMap_0__V]) -> java.util.HashMap[_newHashMap_0__K, _newHashMap_0__V]: ...
    _newHashMap_1__K = _py_TypeVar('_newHashMap_1__K')  # <K>
    _newHashMap_1__V = _py_TypeVar('_newHashMap_1__V')  # <V>
    @classmethod
    @overload
    def newHashMap(cls) -> java.util.HashMap[_newHashMap_1__K, _newHashMap_1__V]: ...
    ...
    @classmethod
    @overload
    def newLinkedHashMap(cls, map: java.util.Map[_newLinkedHashMap_0__K, _newLinkedHashMap_0__V]) -> java.util.LinkedHashMap[_newLinkedHashMap_0__K, _newLinkedHashMap_0__V]: ...
    _newLinkedHashMap_1__K = _py_TypeVar('_newLinkedHashMap_1__K')  # <K>
    _newLinkedHashMap_1__V = _py_TypeVar('_newLinkedHashMap_1__V')  # <V>
    @classmethod
    @overload
    def newLinkedHashMap(cls) -> java.util.LinkedHashMap[_newLinkedHashMap_1__K, _newLinkedHashMap_1__V]: ...
    ...
    _newTreeMap_0__K = _py_TypeVar('_newTreeMap_0__K')  # <K>
    _newTreeMap_0__V = _py_TypeVar('_newTreeMap_0__V')  # <V>
    @classmethod
    @overload
    def newTreeMap(cls, sortedMap: java.util.SortedMap[_newTreeMap_0__K, _newTreeMap_0__V]) -> java.util.TreeMap[_newTreeMap_0__K, _newTreeMap_0__V]: ...
    _newTreeMap_1__K = _py_TypeVar('_newTreeMap_1__K', bound=java.lang.Comparable)  # <K>
    _newTreeMap_1__V = _py_TypeVar('_newTreeMap_1__V')  # <V>
    @classmethod
    @overload
    def newTreeMap(cls) -> java.util.TreeMap[_newTreeMap_1__K, _newTreeMap_1__V]: ...
    _newTreeMap_2__C = _py_TypeVar('_newTreeMap_2__C')  # <C>
    _newTreeMap_2__K = _py_TypeVar('_newTreeMap_2__K')  # <K>
    _newTreeMap_2__V = _py_TypeVar('_newTreeMap_2__V')  # <V>
    @classmethod
    @overload
    def newTreeMap(cls, comparator: java.util.Comparator[_newTreeMap_2__C]) -> java.util.TreeMap[_newTreeMap_2__K, _newTreeMap_2__V]: ...
    ...
    @classmethod
    @overload
    def toImmutableEnumMap(cls, function: java.util.function.Function[_toImmutableEnumMap_0__T, _toImmutableEnumMap_0__K], function2: java.util.function.Function[_toImmutableEnumMap_0__T, _toImmutableEnumMap_0__V], binaryOperator: java.util.function.BinaryOperator[_toImmutableEnumMap_0__V]) -> java.util.stream.Collector[_toImmutableEnumMap_0__T, _py_Any, ImmutableMap[_toImmutableEnumMap_0__K, _toImmutableEnumMap_0__V]]: ...
    ...
    @classmethod
    @overload
    def toImmutableEnumMap(cls, function: java.util.function.Function[_toImmutableEnumMap_1__T, _toImmutableEnumMap_1__K], function2: java.util.function.Function[_toImmutableEnumMap_1__T, _toImmutableEnumMap_1__V]) -> java.util.stream.Collector[_toImmutableEnumMap_1__T, _py_Any, ImmutableMap[_toImmutableEnumMap_1__K, _toImmutableEnumMap_1__V]]: ...
    _toMap_0__K = _py_TypeVar('_toMap_0__K')  # <K>
    _toMap_0__V = _py_TypeVar('_toMap_0__V')  # <V>
    @classmethod
    @overload
    def toMap(cls, iterator: java.util.Iterator[_toMap_0__K], function: com.google.common.base.Function[_toMap_0__K, _toMap_0__V]) -> ImmutableMap[_toMap_0__K, _toMap_0__V]: ...
    _toMap_1__K = _py_TypeVar('_toMap_1__K')  # <K>
    _toMap_1__V = _py_TypeVar('_toMap_1__V')  # <V>
    @classmethod
    @overload
    def toMap(cls, iterable: java.lang.Iterable[_toMap_1__K], function: com.google.common.base.Function[_toMap_1__K, _toMap_1__V]) -> ImmutableMap[_toMap_1__K, _toMap_1__V]: ...
    ...
    @classmethod
    @overload
    def transformEntries(cls, sortedMap: java.util.SortedMap[_transformEntries_0__K, _transformEntries_0__V1], entryTransformer: 'Maps.EntryTransformer'[_transformEntries_0__K, _transformEntries_0__V1, _transformEntries_0__V2]) -> java.util.SortedMap[_transformEntries_0__K, _transformEntries_0__V2]: ...
    ...
    @classmethod
    @overload
    def transformEntries(cls, map: java.util.Map[_transformEntries_2__K, _transformEntries_2__V1], entryTransformer: 'Maps.EntryTransformer'[_transformEntries_2__K, _transformEntries_2__V1, _transformEntries_2__V2]) -> java.util.Map[_transformEntries_2__K, _transformEntries_2__V2]: ...
    ...
    @classmethod
    @overload
    def transformValues(cls, navigableMap: java.util.NavigableMap[_transformValues_0__K, _transformValues_0__V1], function: com.google.common.base.Function[_transformValues_0__V1, _transformValues_0__V2]) -> java.util.NavigableMap[_transformValues_0__K, _transformValues_0__V2]: ...
    ...
    @classmethod
    @overload
    def transformValues(cls, sortedMap: java.util.SortedMap[_transformValues_1__K, _transformValues_1__V1], function: com.google.common.base.Function[_transformValues_1__V1, _transformValues_1__V2]) -> java.util.SortedMap[_transformValues_1__K, _transformValues_1__V2]: ...
    ...
    @classmethod
    @overload
    def transformValues(cls, map: java.util.Map[_transformValues_2__K, _transformValues_2__V1], function: com.google.common.base.Function[_transformValues_2__V1, _transformValues_2__V2]) -> java.util.Map[_transformValues_2__K, _transformValues_2__V2]: ...
...
class MinMaxPriorityQueue(java.util.AbstractQueue[_MinMaxPriorityQueue__E], _py_Generic[_MinMaxPriorityQueue__E]):
    ...
    @classmethod
    @overload
    def create(cls, iterable: java.lang.Iterable[_create_0__E]) -> 'MinMaxPriorityQueue'[_create_0__E]: ...
    _create_1__E = _py_TypeVar('_create_1__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def create(cls) -> 'MinMaxPriorityQueue'[_create_1__E]: ...
    @classmethod
    ...
    class Builder(_py_Generic[_MinMaxPriorityQueue__Builder__B]):
        ...
        @overload
        def create(self, iterable: java.lang.Iterable[_create_0__T]) -> 'MinMaxPriorityQueue'[_create_0__T]: ...
        _create_1__T = _py_TypeVar('_create_1__T')  # <T>
        @overload
        def create(self) -> 'MinMaxPriorityQueue'[_create_1__T]: ...
...
class Multimaps:
    ...
    @classmethod
    @overload
    def asMap(cls, sortedSetMultimap: 'SortedSetMultimap'[_asMap_0__K, _asMap_0__V]) -> java.util.Map[_asMap_0__K, java.util.SortedSet[_asMap_0__V]]: ...
    _asMap_1__K = _py_TypeVar('_asMap_1__K')  # <K>
    _asMap_1__V = _py_TypeVar('_asMap_1__V')  # <V>
    @classmethod
    @overload
    def asMap(cls, setMultimap: 'SetMultimap'[_asMap_1__K, _asMap_1__V]) -> java.util.Map[_asMap_1__K, java.util.Set[_asMap_1__V]]: ...
    _asMap_2__K = _py_TypeVar('_asMap_2__K')  # <K>
    _asMap_2__V = _py_TypeVar('_asMap_2__V')  # <V>
    @classmethod
    @overload
    def asMap(cls, listMultimap: 'ListMultimap'[_asMap_2__K, _asMap_2__V]) -> java.util.Map[_asMap_2__K, java.util.List[_asMap_2__V]]: ...
    _asMap_3__K = _py_TypeVar('_asMap_3__K')  # <K>
    _asMap_3__V = _py_TypeVar('_asMap_3__V')  # <V>
    @classmethod
    @overload
    def asMap(cls, multimap: Multimap[_asMap_3__K, _asMap_3__V]) -> java.util.Map[_asMap_3__K, java.util.Collection[_asMap_3__V]]: ...
    _filterEntries_0__K = _py_TypeVar('_filterEntries_0__K')  # <K>
    _filterEntries_0__V = _py_TypeVar('_filterEntries_0__V')  # <V>
    @classmethod
    @overload
    def filterEntries(cls, setMultimap: 'SetMultimap'[_filterEntries_0__K, _filterEntries_0__V], predicate: com.google.common.base.Predicate[java.util.Map.Entry[_filterEntries_0__K, _filterEntries_0__V]]) -> 'SetMultimap'[_filterEntries_0__K, _filterEntries_0__V]: ...
    _filterEntries_1__K = _py_TypeVar('_filterEntries_1__K')  # <K>
    _filterEntries_1__V = _py_TypeVar('_filterEntries_1__V')  # <V>
    @classmethod
    @overload
    def filterEntries(cls, multimap: Multimap[_filterEntries_1__K, _filterEntries_1__V], predicate: com.google.common.base.Predicate[java.util.Map.Entry[_filterEntries_1__K, _filterEntries_1__V]]) -> Multimap[_filterEntries_1__K, _filterEntries_1__V]: ...
    _filterKeys_0__K = _py_TypeVar('_filterKeys_0__K')  # <K>
    _filterKeys_0__V = _py_TypeVar('_filterKeys_0__V')  # <V>
    @classmethod
    @overload
    def filterKeys(cls, multimap: Multimap[_filterKeys_0__K, _filterKeys_0__V], predicate: com.google.common.base.Predicate[_filterKeys_0__K]) -> Multimap[_filterKeys_0__K, _filterKeys_0__V]: ...
    _filterKeys_1__K = _py_TypeVar('_filterKeys_1__K')  # <K>
    _filterKeys_1__V = _py_TypeVar('_filterKeys_1__V')  # <V>
    @classmethod
    @overload
    def filterKeys(cls, listMultimap: 'ListMultimap'[_filterKeys_1__K, _filterKeys_1__V], predicate: com.google.common.base.Predicate[_filterKeys_1__K]) -> 'ListMultimap'[_filterKeys_1__K, _filterKeys_1__V]: ...
    _filterKeys_2__K = _py_TypeVar('_filterKeys_2__K')  # <K>
    _filterKeys_2__V = _py_TypeVar('_filterKeys_2__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def index(cls, iterator: java.util.Iterator[_index_0__V], function: com.google.common.base.Function[_index_0__V, _index_0__K]) -> 'ImmutableListMultimap'[_index_0__K, _index_0__V]: ...
    _index_1__K = _py_TypeVar('_index_1__K')  # <K>
    _index_1__V = _py_TypeVar('_index_1__V')  # <V>
    @classmethod
    @overload
    def index(cls, iterable: java.lang.Iterable[_index_1__V], function: com.google.common.base.Function[_index_1__V, _index_1__K]) -> 'ImmutableListMultimap'[_index_1__K, _index_1__V]: ...
    ...
    @classmethod
    @overload
    def transformEntries(cls, multimap: Multimap[_transformEntries_0__K, _transformEntries_0__V1], entryTransformer: 'Maps.EntryTransformer'[_transformEntries_0__K, _transformEntries_0__V1, _transformEntries_0__V2]) -> Multimap[_transformEntries_0__K, _transformEntries_0__V2]: ...
    _transformEntries_1__K = _py_TypeVar('_transformEntries_1__K')  # <K>
    _transformEntries_1__V1 = _py_TypeVar('_transformEntries_1__V1')  # <V1>
    _transformEntries_1__V2 = _py_TypeVar('_transformEntries_1__V2')  # <V2>
    @classmethod
    @overload
    def transformEntries(cls, listMultimap: 'ListMultimap'[_transformEntries_1__K, _transformEntries_1__V1], entryTransformer: 'Maps.EntryTransformer'[_transformEntries_1__K, _transformEntries_1__V1, _transformEntries_1__V2]) -> 'ListMultimap'[_transformEntries_1__K, _transformEntries_1__V2]: ...
    _transformValues_0__K = _py_TypeVar('_transformValues_0__K')  # <K>
    _transformValues_0__V1 = _py_TypeVar('_transformValues_0__V1')  # <V1>
    _transformValues_0__V2 = _py_TypeVar('_transformValues_0__V2')  # <V2>
    @classmethod
    ...
    @classmethod
    @overload
    def unmodifiableMultimap(cls, multimap: Multimap[_unmodifiableMultimap_0__K, _unmodifiableMultimap_0__V]) -> Multimap[_unmodifiableMultimap_0__K, _unmodifiableMultimap_0__V]: ...
    ...
    @classmethod
    @overload
    def unmodifiableMultimap(cls, immutableMultimap: 'ImmutableMultimap'[_unmodifiableMultimap_1__K, _unmodifiableMultimap_1__V]) -> Multimap[_unmodifiableMultimap_1__K, _unmodifiableMultimap_1__V]: ...
...
class ObjectArrays:
    ...
    @classmethod
    @overload
    def concat(cls, tArray: _py_List[_concat_0__T], t2: _concat_0__T) -> _py_List[_concat_0__T]: ...
    _concat_1__T = _py_TypeVar('_concat_1__T')  # <T>
    @classmethod
    @overload
    def concat(cls, t: _concat_1__T, tArray: _py_List[_concat_1__T]) -> _py_List[_concat_1__T]: ...
    _concat_2__T = _py_TypeVar('_concat_2__T')  # <T>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def newArray(cls, tArray: _py_List[_newArray_0__T], int: int) -> _py_List[_newArray_0__T]: ...
    _newArray_1__T = _py_TypeVar('_newArray_1__T')  # <T>
    @classmethod
    @overload
    def newArray(cls, class_: _py_Type[_newArray_1__T], int: int) -> _py_List[_newArray_1__T]: ...
...
class Ordering(java.util.Comparator[_Ordering__T], _py_Generic[_Ordering__T]):
    ...
    @overload
    def leastOf(self, iterator: java.util.Iterator[_leastOf_0__E], int: int) -> java.util.List[_leastOf_0__E]: ...
    _leastOf_1__E = _py_TypeVar('_leastOf_1__E')  # <E>
    @overload
    def leastOf(self, iterable: java.lang.Iterable[_leastOf_1__E], int: int) -> java.util.List[_leastOf_1__E]: ...
    _lexicographical__S = _py_TypeVar('_lexicographical__S')  # <S>
    def lexicographical(self) -> 'Ordering'[java.lang.Iterable[_lexicographical__S]]: ...
    _max_0__E = _py_TypeVar('_max_0__E')  # <E>
    @overload
    def max(self, e: _max_0__E, e2: _max_0__E, e3: _max_0__E, eArray: _py_List[_max_0__E]) -> _max_0__E: ...
    _max_1__E = _py_TypeVar('_max_1__E')  # <E>
    @overload
    def max(self, iterator: java.util.Iterator[_max_1__E]) -> _max_1__E: ...
    _max_2__E = _py_TypeVar('_max_2__E')  # <E>
    @overload
    def max(self, e: _max_2__E, e2: _max_2__E) -> _max_2__E: ...
    _max_3__E = _py_TypeVar('_max_3__E')  # <E>
    @overload
    def max(self, iterable: java.lang.Iterable[_max_3__E]) -> _max_3__E: ...
    _min_0__E = _py_TypeVar('_min_0__E')  # <E>
    @overload
    def min(self, e: _min_0__E, e2: _min_0__E, e3: _min_0__E, eArray: _py_List[_min_0__E]) -> _min_0__E: ...
...
class Queues:
    ...
    @classmethod
    @overload
    def drain(cls, blockingQueue: java.util.concurrent.BlockingQueue[_drain_0__E], collection: java.util.Collection[_drain_0__E], int: int, long: int, timeUnit: java.util.concurrent.TimeUnit) -> int: ...
    _drain_1__E = _py_TypeVar('_drain_1__E')  # <E>
    @classmethod
    @overload
    def drain(cls, blockingQueue: java.util.concurrent.BlockingQueue[_drain_1__E], collection: java.util.Collection[_drain_1__E], int: int, duration: java.time.Duration) -> int: ...
    ...
    @classmethod
    @overload
    def newArrayDeque(cls, iterable: java.lang.Iterable[_newArrayDeque_0__E]) -> java.util.ArrayDeque[_newArrayDeque_0__E]: ...
    _newArrayDeque_1__E = _py_TypeVar('_newArrayDeque_1__E')  # <E>
    @classmethod
    @overload
    def newArrayDeque(cls) -> java.util.ArrayDeque[_newArrayDeque_1__E]: ...
    ...
    @classmethod
    @overload
    def newLinkedBlockingDeque(cls, iterable: java.lang.Iterable[_newLinkedBlockingDeque_0__E]) -> java.util.concurrent.LinkedBlockingDeque[_newLinkedBlockingDeque_0__E]: ...
    _newLinkedBlockingDeque_1__E = _py_TypeVar('_newLinkedBlockingDeque_1__E')  # <E>
    @classmethod
    @overload
    def newLinkedBlockingDeque(cls) -> java.util.concurrent.LinkedBlockingDeque[_newLinkedBlockingDeque_1__E]: ...
    _newLinkedBlockingDeque_2__E = _py_TypeVar('_newLinkedBlockingDeque_2__E')  # <E>
    @classmethod
    @overload
    def newLinkedBlockingDeque(cls, int: int) -> java.util.concurrent.LinkedBlockingDeque[_newLinkedBlockingDeque_2__E]: ...
...
class Sets:
    ...
    @classmethod
    @overload
    def cartesianProduct(cls, setArray: _py_List[java.util.Set[_cartesianProduct_0__B]]) -> java.util.Set[java.util.List[_cartesianProduct_0__B]]: ...
    _cartesianProduct_1__B = _py_TypeVar('_cartesianProduct_1__B')  # <B>
    @classmethod
    @overload
    def cartesianProduct(cls, list: java.util.List[java.util.Set[_cartesianProduct_1__B]]) -> java.util.Set[java.util.List[_cartesianProduct_1__B]]: ...
    ...
    @classmethod
    @overload
    def newConcurrentHashSet(cls, iterable: java.lang.Iterable[_newConcurrentHashSet_0__E]) -> java.util.Set[_newConcurrentHashSet_0__E]: ...
    _newConcurrentHashSet_1__E = _py_TypeVar('_newConcurrentHashSet_1__E')  # <E>
    @classmethod
    @overload
    def newConcurrentHashSet(cls) -> java.util.Set[_newConcurrentHashSet_1__E]: ...
    _newCopyOnWriteArraySet_0__E = _py_TypeVar('_newCopyOnWriteArraySet_0__E')  # <E>
    @classmethod
    @overload
    def newCopyOnWriteArraySet(cls, iterable: java.lang.Iterable[_newCopyOnWriteArraySet_0__E]) -> java.util.concurrent.CopyOnWriteArraySet[_newCopyOnWriteArraySet_0__E]: ...
    _newCopyOnWriteArraySet_1__E = _py_TypeVar('_newCopyOnWriteArraySet_1__E')  # <E>
    @classmethod
    @overload
    def newCopyOnWriteArraySet(cls) -> java.util.concurrent.CopyOnWriteArraySet[_newCopyOnWriteArraySet_1__E]: ...
    ...
    @classmethod
    @overload
    def newHashSet(cls, iterator: java.util.Iterator[_newHashSet_0__E]) -> java.util.HashSet[_newHashSet_0__E]: ...
    _newHashSet_1__E = _py_TypeVar('_newHashSet_1__E')  # <E>
    @classmethod
    @overload
    def newHashSet(cls, eArray: _py_List[_newHashSet_1__E]) -> java.util.HashSet[_newHashSet_1__E]: ...
    _newHashSet_2__E = _py_TypeVar('_newHashSet_2__E')  # <E>
    @classmethod
    @overload
    def newHashSet(cls, iterable: java.lang.Iterable[_newHashSet_2__E]) -> java.util.HashSet[_newHashSet_2__E]: ...
    _newHashSet_3__E = _py_TypeVar('_newHashSet_3__E')  # <E>
    @classmethod
    @overload
    def newHashSet(cls) -> java.util.HashSet[_newHashSet_3__E]: ...
    ...
    @classmethod
    @overload
    def newLinkedHashSet(cls, iterable: java.lang.Iterable[_newLinkedHashSet_0__E]) -> java.util.LinkedHashSet[_newLinkedHashSet_0__E]: ...
    _newLinkedHashSet_1__E = _py_TypeVar('_newLinkedHashSet_1__E')  # <E>
    @classmethod
    @overload
    def newLinkedHashSet(cls) -> java.util.LinkedHashSet[_newLinkedHashSet_1__E]: ...
    ...
    _newTreeSet_0__E = _py_TypeVar('_newTreeSet_0__E')  # <E>
    @classmethod
    @overload
    def newTreeSet(cls, comparator: java.util.Comparator[_newTreeSet_0__E]) -> java.util.TreeSet[_newTreeSet_0__E]: ...
    ...
    _newTreeSet_2__E = _py_TypeVar('_newTreeSet_2__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def newTreeSet(cls) -> java.util.TreeSet[_newTreeSet_2__E]: ...
...
class SortedLists:
    ...
    @classmethod
    @overload
    def binarySearch(cls, list: java.util.List[_binarySearch_0__E], e: _binarySearch_0__E, comparator: java.util.Comparator[_binarySearch_0__E], keyPresentBehavior: 'SortedLists.KeyPresentBehavior', keyAbsentBehavior: 'SortedLists.KeyAbsentBehavior') -> int: ...
    ...
    _binarySearch_2__E = _py_TypeVar('_binarySearch_2__E')  # <E>
    _binarySearch_2__K = _py_TypeVar('_binarySearch_2__K', bound=java.lang.Comparable)  # <K>
    @classmethod
    @overload
    def binarySearch(cls, list: java.util.List[_binarySearch_2__E], function: com.google.common.base.Function[_binarySearch_2__E, _binarySearch_2__K], k: _binarySearch_2__K, keyPresentBehavior: 'SortedLists.KeyPresentBehavior', keyAbsentBehavior: 'SortedLists.KeyAbsentBehavior') -> int: ...
    _binarySearch_3__E = _py_TypeVar('_binarySearch_3__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def binarySearch(cls, list: java.util.List[_binarySearch_3__E], e: _binarySearch_3__E, keyPresentBehavior: 'SortedLists.KeyPresentBehavior', keyAbsentBehavior: 'SortedLists.KeyAbsentBehavior') -> int: ...
...
class Streams:
    ...
    @classmethod
    @overload
    def concat(cls, streamArray: _py_List[java.util.stream.Stream[_concat_0__T]]) -> java.util.stream.Stream[_concat_0__T]: ...
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def mapWithIndex(cls, intStream: java.util.stream.IntStream, intFunctionWithIndex: 'Streams.IntFunctionWithIndex'[_mapWithIndex_0__R]) -> java.util.stream.Stream[_mapWithIndex_0__R]: ...
    _mapWithIndex_1__T = _py_TypeVar('_mapWithIndex_1__T')  # <T>
    _mapWithIndex_1__R = _py_TypeVar('_mapWithIndex_1__R')  # <R>
    @classmethod
    @overload
    def mapWithIndex(cls, stream: java.util.stream.Stream[_mapWithIndex_1__T], functionWithIndex: 'Streams.FunctionWithIndex'[_mapWithIndex_1__T, _mapWithIndex_1__R]) -> java.util.stream.Stream[_mapWithIndex_1__R]: ...
    _mapWithIndex_2__R = _py_TypeVar('_mapWithIndex_2__R')  # <R>
    @classmethod
    @overload
    def mapWithIndex(cls, doubleStream: java.util.stream.DoubleStream, doubleFunctionWithIndex: 'Streams.DoubleFunctionWithIndex'[_mapWithIndex_2__R]) -> java.util.stream.Stream[_mapWithIndex_2__R]: ...
    _mapWithIndex_3__R = _py_TypeVar('_mapWithIndex_3__R')  # <R>
    @classmethod
    @overload
    def mapWithIndex(cls, longStream: java.util.stream.LongStream, longFunctionWithIndex: 'Streams.LongFunctionWithIndex'[_mapWithIndex_3__R]) -> java.util.stream.Stream[_mapWithIndex_3__R]: ...
    _stream_0__T = _py_TypeVar('_stream_0__T')  # <T>
    @classmethod
    @overload
    def stream(cls, collection: java.util.Collection[_stream_0__T]) -> java.util.stream.Stream[_stream_0__T]: ...
    _stream_1__T = _py_TypeVar('_stream_1__T')  # <T>
    @classmethod
    @overload
    def stream(cls, iterator: java.util.Iterator[_stream_1__T]) -> java.util.stream.Stream[_stream_1__T]: ...
    _stream_2__T = _py_TypeVar('_stream_2__T')  # <T>
    @classmethod
    @overload
    def stream(cls, optional: com.google.common.base.Optional[_stream_2__T]) -> java.util.stream.Stream[_stream_2__T]: ...
    _stream_3__T = _py_TypeVar('_stream_3__T')  # <T>
    @classmethod
    @overload
    def stream(cls, optional: java.util.Optional[_stream_3__T]) -> java.util.stream.Stream[_stream_3__T]: ...
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def stream(cls, iterable: java.lang.Iterable[_stream_5__T]) -> java.util.stream.Stream[_stream_5__T]: ...
    @classmethod
    @overload
...
class TopKSelector(_py_Generic[_TopKSelector__T]):
    _greatest_0__T = _py_TypeVar('_greatest_0__T')  # <T>
    @classmethod
    @overload
    def greatest(cls, int: int, comparator: java.util.Comparator[_greatest_0__T]) -> 'TopKSelector'[_greatest_0__T]: ...
    _greatest_1__T = _py_TypeVar('_greatest_1__T', bound=java.lang.Comparable)  # <T>
    @classmethod
    @overload
    def greatest(cls, int: int) -> 'TopKSelector'[_greatest_1__T]: ...
...
class CompactLinkedHashMap(CompactHashMap[_CompactLinkedHashMap__K, _CompactLinkedHashMap__V], _py_Generic[_CompactLinkedHashMap__K, _CompactLinkedHashMap__V]):
    ...
    @classmethod
    @overload
    def create(cls) -> 'CompactLinkedHashMap'[_create_0__K, _create_0__V]: ...
    _create_1__K = _py_TypeVar('_create_1__K')  # <K>
    _create_1__V = _py_TypeVar('_create_1__V')  # <V>
    @classmethod
    @overload
    def create(cls) -> CompactHashMap[_create_1__K, _create_1__V]: ...
    ...
    @classmethod
    @overload
    def createWithExpectedSize(cls, int: int) -> 'CompactLinkedHashMap'[_createWithExpectedSize_0__K, _createWithExpectedSize_0__V]: ...
    ...
    @classmethod
    @overload
    def createWithExpectedSize(cls, int: int) -> CompactHashMap[_createWithExpectedSize_1__K, _createWithExpectedSize_1__V]: ...
...
class CompactLinkedHashSet(CompactHashSet[_CompactLinkedHashSet__E], _py_Generic[_CompactLinkedHashSet__E]):
    ...
    @classmethod
    @overload
    def create(cls) -> 'CompactLinkedHashSet'[_create_0__E]: ...
    _create_1__E = _py_TypeVar('_create_1__E')  # <E>
    @classmethod
    @overload
    def create(cls, collection: java.util.Collection[_create_1__E]) -> 'CompactLinkedHashSet'[_create_1__E]: ...
    _create_2__E = _py_TypeVar('_create_2__E')  # <E>
    @classmethod
    @overload
    def create(cls, eArray: _py_List[_create_2__E]) -> 'CompactLinkedHashSet'[_create_2__E]: ...
    _create_3__E = _py_TypeVar('_create_3__E')  # <E>
    @classmethod
    @overload
    def create(cls, collection: java.util.Collection[_create_3__E]) -> CompactHashSet[_create_3__E]: ...
    _create_4__E = _py_TypeVar('_create_4__E')  # <E>
    @classmethod
    @overload
    def create(cls) -> CompactHashSet[_create_4__E]: ...
    _create_5__E = _py_TypeVar('_create_5__E')  # <E>
    @classmethod
    @overload
    def create(cls, eArray: _py_List[_create_5__E]) -> CompactHashSet[_create_5__E]: ...
    _createWithExpectedSize_0__E = _py_TypeVar('_createWithExpectedSize_0__E')  # <E>
    @classmethod
    @overload
    def createWithExpectedSize(cls, int: int) -> 'CompactLinkedHashSet'[_createWithExpectedSize_0__E]: ...
    _createWithExpectedSize_1__E = _py_TypeVar('_createWithExpectedSize_1__E')  # <E>
    @classmethod
    @overload
    def createWithExpectedSize(cls, int: int) -> CompactHashSet[_createWithExpectedSize_1__E]: ...
...
class ImmutableRangeMap(RangeMap[_ImmutableRangeMap__K, _ImmutableRangeMap__V], java.io.Serializable, _py_Generic[_ImmutableRangeMap__K, _ImmutableRangeMap__V]):
    ...
    @classmethod
    @overload
    def of(cls, range: 'Range'[_of_0__K], v: _of_0__V) -> 'ImmutableRangeMap'[_of_0__K, _of_0__V]: ...
    _of_1__K = _py_TypeVar('_of_1__K', bound=java.lang.Comparable)  # <K>
    _of_1__V = _py_TypeVar('_of_1__V')  # <V>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableRangeMap'[_of_1__K, _of_1__V]: ...
...
class ImmutableSortedMapFauxverideShim(ImmutableMap[_ImmutableSortedMapFauxverideShim__K, _ImmutableSortedMapFauxverideShim__V], _py_Generic[_ImmutableSortedMapFauxverideShim__K, _ImmutableSortedMapFauxverideShim__V]):
    ...
    @classmethod
    @overload
    def builder(cls) -> 'ImmutableSortedMap.Builder'[_builder_0__K, _builder_0__V]: ...
    ...
    @classmethod
    @overload
    def builderWithExpectedSize(cls, int: int) -> 'ImmutableSortedMap.Builder'[_builderWithExpectedSize_0__K, _builderWithExpectedSize_0__V]: ...
    ...
    @classmethod
    @overload
    def of(cls, k: _of_0__K, v: _of_0__V, k2: _of_0__K, v2: _of_0__V, k3: _of_0__K, v3: _of_0__V, k4: _of_0__K, v4: _of_0__V, k5: _of_0__K, v5: _of_0__V) -> 'ImmutableSortedMap'[_of_0__K, _of_0__V]: ...
    _of_1__K = _py_TypeVar('_of_1__K')  # <K>
    _of_1__V = _py_TypeVar('_of_1__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_1__K, v: _of_1__V, k2: _of_1__K, v2: _of_1__V, k3: _of_1__K, v3: _of_1__V, k4: _of_1__K, v4: _of_1__V) -> 'ImmutableSortedMap'[_of_1__K, _of_1__V]: ...
    _of_2__K = _py_TypeVar('_of_2__K')  # <K>
    _of_2__V = _py_TypeVar('_of_2__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_2__K, v: _of_2__V, k2: _of_2__K, v2: _of_2__V, k3: _of_2__K, v3: _of_2__V) -> 'ImmutableSortedMap'[_of_2__K, _of_2__V]: ...
    _of_3__K = _py_TypeVar('_of_3__K')  # <K>
    _of_3__V = _py_TypeVar('_of_3__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_3__K, v: _of_3__V, k2: _of_3__K, v2: _of_3__V) -> 'ImmutableSortedMap'[_of_3__K, _of_3__V]: ...
    _of_4__K = _py_TypeVar('_of_4__K')  # <K>
    _of_4__V = _py_TypeVar('_of_4__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_4__K, v: _of_4__V) -> 'ImmutableSortedMap'[_of_4__K, _of_4__V]: ...
    _of_5__K = _py_TypeVar('_of_5__K')  # <K>
    _of_5__V = _py_TypeVar('_of_5__V')  # <V>
    @classmethod
    @overload
    def of(cls) -> ImmutableMap[_of_5__K, _of_5__V]: ...
    _of_6__K = _py_TypeVar('_of_6__K')  # <K>
    _of_6__V = _py_TypeVar('_of_6__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_6__K, v: _of_6__V, k2: _of_6__K, v2: _of_6__V, k3: _of_6__K, v3: _of_6__V, k4: _of_6__K, v4: _of_6__V) -> ImmutableMap[_of_6__K, _of_6__V]: ...
    _of_7__K = _py_TypeVar('_of_7__K')  # <K>
    _of_7__V = _py_TypeVar('_of_7__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_7__K, v: _of_7__V, k2: _of_7__K, v2: _of_7__V, k3: _of_7__K, v3: _of_7__V, k4: _of_7__K, v4: _of_7__V, k5: _of_7__K, v5: _of_7__V) -> ImmutableMap[_of_7__K, _of_7__V]: ...
    _of_8__K = _py_TypeVar('_of_8__K')  # <K>
    _of_8__V = _py_TypeVar('_of_8__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_8__K, v: _of_8__V, k2: _of_8__K, v2: _of_8__V, k3: _of_8__K, v3: _of_8__V) -> ImmutableMap[_of_8__K, _of_8__V]: ...
    _of_9__K = _py_TypeVar('_of_9__K')  # <K>
    _of_9__V = _py_TypeVar('_of_9__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_9__K, v: _of_9__V) -> ImmutableMap[_of_9__K, _of_9__V]: ...
    _of_10__K = _py_TypeVar('_of_10__K')  # <K>
    _of_10__V = _py_TypeVar('_of_10__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_10__K, v: _of_10__V, k2: _of_10__K, v2: _of_10__V) -> ImmutableMap[_of_10__K, _of_10__V]: ...
    _toImmutableMap_0__T = _py_TypeVar('_toImmutableMap_0__T')  # <T>
    _toImmutableMap_0__K = _py_TypeVar('_toImmutableMap_0__K')  # <K>
    _toImmutableMap_0__V = _py_TypeVar('_toImmutableMap_0__V')  # <V>
    @classmethod
...
class ReverseNaturalOrdering(Ordering[java.lang.Comparable], java.io.Serializable):
    ...
    @overload
    def max(self, iterable: java.lang.Iterable[_max_3__E]) -> _max_3__E: ...
    _max_4__E = _py_TypeVar('_max_4__E', bound=java.lang.Comparable)  # <E>
    @overload
    def max(self, iterator: java.util.Iterator[_max_4__E]) -> _max_4__E: ...
    _max_5__E = _py_TypeVar('_max_5__E', bound=java.lang.Comparable)  # <E>
    @overload
    def max(self, e: _max_5__E, e2: _max_5__E, e3: _max_5__E, eArray: _py_List[_max_5__E]) -> _max_5__E: ...
    _max_6__E = _py_TypeVar('_max_6__E', bound=java.lang.Comparable)  # <E>
    @overload
    def max(self, e: _max_6__E, e2: _max_6__E) -> _max_6__E: ...
    @overload
    ...
    @overload
    def min(self, e: _min_3__E, e2: _min_3__E) -> _min_3__E: ...
    _min_4__E = _py_TypeVar('_min_4__E', bound=java.lang.Comparable)  # <E>
    @overload
    def min(self, e: _min_4__E, e2: _min_4__E, e3: _min_4__E, eArray: _py_List[_min_4__E]) -> _min_4__E: ...
    _min_5__E = _py_TypeVar('_min_5__E', bound=java.lang.Comparable)  # <E>
    @overload
    def min(self, iterator: java.util.Iterator[_min_5__E]) -> _min_5__E: ...
    _min_6__E = _py_TypeVar('_min_6__E', bound=java.lang.Comparable)  # <E>
    @overload
    def min(self, iterable: java.lang.Iterable[_min_6__E]) -> _min_6__E: ...
    @overload
...
class ReverseOrdering(Ordering[_ReverseOrdering__T], java.io.Serializable, _py_Generic[_ReverseOrdering__T]):
    ...
    _max_1__E = _py_TypeVar('_max_1__E')  # <E>
    @overload
    def max(self, iterable: java.lang.Iterable[_max_1__E]) -> _max_1__E: ...
    _max_2__E = _py_TypeVar('_max_2__E')  # <E>
    @overload
    def max(self, iterator: java.util.Iterator[_max_2__E]) -> _max_2__E: ...
    _max_3__E = _py_TypeVar('_max_3__E')  # <E>
    @overload
    def max(self, e: _max_3__E, e2: _max_3__E, e3: _max_3__E, eArray: _py_List[_max_3__E]) -> _max_3__E: ...
    _min_0__E = _py_TypeVar('_min_0__E')  # <E>
    @overload
    def min(self, iterable: java.lang.Iterable[_min_0__E]) -> _min_0__E: ...
    _min_1__E = _py_TypeVar('_min_1__E')  # <E>
    @overload
    def min(self, iterator: java.util.Iterator[_min_1__E]) -> _min_1__E: ...
    _min_2__E = _py_TypeVar('_min_2__E')  # <E>
    @overload
    def min(self, e: _min_2__E, e2: _min_2__E) -> _min_2__E: ...
    _min_3__E = _py_TypeVar('_min_3__E')  # <E>
    @overload
    def min(self, e: _min_3__E, e2: _min_3__E, e3: _min_3__E, eArray: _py_List[_min_3__E]) -> _min_3__E: ...
    _reverse__S = _py_TypeVar('_reverse__S')  # <S>
    def reverse(self) -> Ordering[_reverse__S]: ...
    def toString(self) -> str: ...
...
class ArrayTable(AbstractTable[_ArrayTable__R, _ArrayTable__C, _ArrayTable__V], java.io.Serializable, _py_Generic[_ArrayTable__R, _ArrayTable__C, _ArrayTable__V]):
    ...
    @classmethod
    @overload
    def create(cls, iterable: java.lang.Iterable[_create_0__R], iterable2: java.lang.Iterable[_create_0__C]) -> 'ArrayTable'[_create_0__R, _create_0__C, _create_0__V]: ...
    _create_1__R = _py_TypeVar('_create_1__R')  # <R>
    _create_1__C = _py_TypeVar('_create_1__C')  # <C>
    _create_1__V = _py_TypeVar('_create_1__V')  # <V>
    @classmethod
    @overload
    def create(cls, table: Table[_create_1__R, _create_1__C, _create_1__V]) -> 'ArrayTable'[_create_1__R, _create_1__C, _create_1__V]: ...
    def equals(self, object: _py_Any) -> bool: ...
...
class ConcurrentHashMultiset(AbstractMultiset[_ConcurrentHashMultiset__E], java.io.Serializable, _py_Generic[_ConcurrentHashMultiset__E]):
    ...
    @classmethod
    @overload
    def create(cls, iterable: java.lang.Iterable[_create_0__E]) -> 'ConcurrentHashMultiset'[_create_0__E]: ...
    _create_1__E = _py_TypeVar('_create_1__E')  # <E>
    @classmethod
    @overload
    def create(cls) -> 'ConcurrentHashMultiset'[_create_1__E]: ...
    _create_2__E = _py_TypeVar('_create_2__E')  # <E>
    @classmethod
    @overload
...
class EnumMultiset(AbstractMultiset[_EnumMultiset__E], java.io.Serializable, _py_Generic[_EnumMultiset__E]):
    ...
    @classmethod
    @overload
    def create(cls, iterable: java.lang.Iterable[_create_1__E], class_: _py_Type[_create_1__E]) -> 'EnumMultiset'[_create_1__E]: ...
    _create_2__E = _py_TypeVar('_create_2__E', bound=java.lang.Enum)  # <E>
    @classmethod
    @overload
    def create(cls, iterable: java.lang.Iterable[_create_2__E]) -> 'EnumMultiset'[_create_2__E]: ...
    def elementSet(self) -> java.util.Set: ...
    def entrySet(self) -> java.util.Set: ...
...
class ImmutableClassToInstanceMap(ForwardingMap[_py_Type[_ImmutableClassToInstanceMap__B], _ImmutableClassToInstanceMap__B], ClassToInstanceMap[_ImmutableClassToInstanceMap__B], java.io.Serializable, _py_Generic[_ImmutableClassToInstanceMap__B]):
    ...
    @classmethod
    @overload
    def of(cls, class_: _py_Type[_of_0__T], t: _of_0__T) -> 'ImmutableClassToInstanceMap'[_of_0__B]: ...
    _of_1__B = _py_TypeVar('_of_1__B')  # <B>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableClassToInstanceMap'[_of_1__B]: ...
    _putInstance__T = _py_TypeVar('_putInstance__T')  # <T>
    def putInstance(self, class_: _py_Type[_putInstance__T], t: _putInstance__T) -> _putInstance__T: ...
...
class ImmutableRangeSet(AbstractRangeSet[_ImmutableRangeSet__C], java.io.Serializable, _py_Generic[_ImmutableRangeSet__C]):
    ...
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[Range[_copyOf_0__C]]) -> 'ImmutableRangeSet'[_copyOf_0__C]: ...
    _copyOf_1__C = _py_TypeVar('_copyOf_1__C', bound=java.lang.Comparable)  # <C>
    @classmethod
    @overload
    def copyOf(cls, rangeSet: RangeSet[_copyOf_1__C]) -> 'ImmutableRangeSet'[_copyOf_1__C]: ...
...
class LinkedListMultimap(AbstractMultimap[_LinkedListMultimap__K, _LinkedListMultimap__V], ListMultimap[_LinkedListMultimap__K, _LinkedListMultimap__V], java.io.Serializable, _py_Generic[_LinkedListMultimap__K, _LinkedListMultimap__V]):
    ...
    @classmethod
    @overload
    def create(cls, int: int) -> 'LinkedListMultimap'[_create_0__K, _create_0__V]: ...
    _create_1__K = _py_TypeVar('_create_1__K')  # <K>
    _create_1__V = _py_TypeVar('_create_1__V')  # <V>
    @classmethod
    @overload
    def create(cls) -> 'LinkedListMultimap'[_create_1__K, _create_1__V]: ...
    _create_2__K = _py_TypeVar('_create_2__K')  # <K>
    _create_2__V = _py_TypeVar('_create_2__V')  # <V>
    @classmethod
    @overload
    def create(cls, multimap: Multimap[_create_2__K, _create_2__V]) -> 'LinkedListMultimap'[_create_2__K, _create_2__V]: ...
    @overload
...
class MutableClassToInstanceMap(ForwardingMap[_py_Type[_MutableClassToInstanceMap__B], _MutableClassToInstanceMap__B], ClassToInstanceMap[_MutableClassToInstanceMap__B], java.io.Serializable, _py_Generic[_MutableClassToInstanceMap__B]):
    ...
    @classmethod
    @overload
    def create(cls, map: java.util.Map[_py_Type[_create_0__B], _create_0__B]) -> 'MutableClassToInstanceMap'[_create_0__B]: ...
    _create_1__B = _py_TypeVar('_create_1__B')  # <B>
    @classmethod
    @overload
    def create(cls) -> 'MutableClassToInstanceMap'[_create_1__B]: ...
...
class EnumBiMap(AbstractBiMap[_EnumBiMap__K, _EnumBiMap__V], _py_Generic[_EnumBiMap__K, _EnumBiMap__V]):
    ...
    @classmethod
    @overload
    def create(cls, map: java.util.Map[_create_0__K, _create_0__V]) -> 'EnumBiMap'[_create_0__K, _create_0__V]: ...
    _create_1__K = _py_TypeVar('_create_1__K', bound=java.lang.Enum)  # <K>
    _create_1__V = _py_TypeVar('_create_1__V', bound=java.lang.Enum)  # <V>
    @classmethod
    @overload
    def create(cls, class_: _py_Type[_create_1__K], class2: _py_Type[_create_1__V]) -> 'EnumBiMap'[_create_1__K, _create_1__V]: ...
    def entrySet(self) -> java.util.Set: ...
...
class EnumHashBiMap(AbstractBiMap[_EnumHashBiMap__K, _EnumHashBiMap__V], _py_Generic[_EnumHashBiMap__K, _EnumHashBiMap__V]):
    ...
    @classmethod
    @overload
    def create(cls, map: java.util.Map[_create_0__K, _create_0__V]) -> 'EnumHashBiMap'[_create_0__K, _create_0__V]: ...
    _create_1__K = _py_TypeVar('_create_1__K', bound=java.lang.Enum)  # <K>
    _create_1__V = _py_TypeVar('_create_1__V')  # <V>
    @classmethod
    @overload
    def create(cls, class_: _py_Type[_create_1__K]) -> 'EnumHashBiMap'[_create_1__K, _create_1__V]: ...
    def entrySet(self) -> java.util.Set: ...
    @overload
...
class HashBasedTable(StandardTable[_HashBasedTable__R, _HashBasedTable__C, _HashBasedTable__V], _py_Generic[_HashBasedTable__R, _HashBasedTable__C, _HashBasedTable__V]):
    ...
    @classmethod
    @overload
    def create(cls, int: int, int2: int) -> 'HashBasedTable'[_create_1__R, _create_1__C, _create_1__V]: ...
    _create_2__R = _py_TypeVar('_create_2__R')  # <R>
    _create_2__C = _py_TypeVar('_create_2__C')  # <C>
    _create_2__V = _py_TypeVar('_create_2__V')  # <V>
    @classmethod
    @overload
    def create(cls, table: Table[_create_2__R, _create_2__C, _create_2__V]) -> 'HashBasedTable'[_create_2__R, _create_2__C, _create_2__V]: ...
    def equals(self, object: _py_Any) -> bool: ...
...
class ImmutableMultimap(BaseImmutableMultimap[_ImmutableMultimap__K, _ImmutableMultimap__V], java.io.Serializable, _py_Generic[_ImmutableMultimap__K, _ImmutableMultimap__V]):
    ...
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[java.util.Map.Entry[_copyOf_0__K, _copyOf_0__V]]) -> 'ImmutableMultimap'[_copyOf_0__K, _copyOf_0__V]: ...
    _copyOf_1__K = _py_TypeVar('_copyOf_1__K')  # <K>
    _copyOf_1__V = _py_TypeVar('_copyOf_1__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, multimap: Multimap[_copyOf_1__K, _copyOf_1__V]) -> 'ImmutableMultimap'[_copyOf_1__K, _copyOf_1__V]: ...
    @overload
    ...
    @classmethod
    @overload
    def of(cls, k: _of_2__K, v: _of_2__V, k2: _of_2__K, v2: _of_2__V, k3: _of_2__K, v3: _of_2__V, k4: _of_2__K, v4: _of_2__V) -> 'ImmutableMultimap'[_of_2__K, _of_2__V]: ...
    _of_3__K = _py_TypeVar('_of_3__K')  # <K>
    _of_3__V = _py_TypeVar('_of_3__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_3__K, v: _of_3__V, k2: _of_3__K, v2: _of_3__V, k3: _of_3__K, v3: _of_3__V, k4: _of_3__K, v4: _of_3__V, k5: _of_3__K, v5: _of_3__V) -> 'ImmutableMultimap'[_of_3__K, _of_3__V]: ...
    _of_4__K = _py_TypeVar('_of_4__K')  # <K>
    _of_4__V = _py_TypeVar('_of_4__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_4__K, v: _of_4__V, k2: _of_4__K, v2: _of_4__V) -> 'ImmutableMultimap'[_of_4__K, _of_4__V]: ...
    _of_5__K = _py_TypeVar('_of_5__K')  # <K>
    _of_5__V = _py_TypeVar('_of_5__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_5__K, v: _of_5__V, k2: _of_5__K, v2: _of_5__V, k3: _of_5__K, v3: _of_5__V) -> 'ImmutableMultimap'[_of_5__K, _of_5__V]: ...
...
class TreeBasedTable(StandardRowSortedTable[_TreeBasedTable__R, _TreeBasedTable__C, _TreeBasedTable__V], _py_Generic[_TreeBasedTable__R, _TreeBasedTable__C, _TreeBasedTable__V]):
    ...
    @classmethod
    @overload
    def create(cls, comparator: java.util.Comparator[_create_0__R], comparator2: java.util.Comparator[_create_0__C]) -> 'TreeBasedTable'[_create_0__R, _create_0__C, _create_0__V]: ...
    _create_1__R = _py_TypeVar('_create_1__R', bound=java.lang.Comparable)  # <R>
    _create_1__C = _py_TypeVar('_create_1__C', bound=java.lang.Comparable)  # <C>
    _create_1__V = _py_TypeVar('_create_1__V')  # <V>
    @classmethod
    @overload
    def create(cls) -> 'TreeBasedTable'[_create_1__R, _create_1__C, _create_1__V]: ...
    _create_2__R = _py_TypeVar('_create_2__R')  # <R>
    _create_2__C = _py_TypeVar('_create_2__C')  # <C>
    _create_2__V = _py_TypeVar('_create_2__V')  # <V>
    @classmethod
    @overload
    def create(cls, treeBasedTable: 'TreeBasedTable'[_create_2__R, _create_2__C, _create_2__V]) -> 'TreeBasedTable'[_create_2__R, _create_2__C, _create_2__V]: ...
    def equals(self, object: _py_Any) -> bool: ...
    def get(self, object: _py_Any, object2: _py_Any) -> _py_Any: ...
    def hashCode(self) -> int: ...
    def isEmpty(self) -> bool: ...
...
class ArrayListMultimap(ArrayListMultimapGwtSerializationDependencies[_ArrayListMultimap__K, _ArrayListMultimap__V], _py_Generic[_ArrayListMultimap__K, _ArrayListMultimap__V]):
    ...
    @classmethod
    @overload
    def create(cls, int: int, int2: int) -> 'ArrayListMultimap'[_create_1__K, _create_1__V]: ...
    _create_2__K = _py_TypeVar('_create_2__K')  # <K>
    _create_2__V = _py_TypeVar('_create_2__V')  # <V>
    @classmethod
    @overload
    def create(cls, multimap: Multimap[_create_2__K, _create_2__V]) -> 'ArrayListMultimap'[_create_2__K, _create_2__V]: ...
    def entries(self) -> java.util.Collection: ...
    def equals(self, object: _py_Any) -> bool: ...
...
class HashMultimap(HashMultimapGwtSerializationDependencies[_HashMultimap__K, _HashMultimap__V], _py_Generic[_HashMultimap__K, _HashMultimap__V]):
    ...
    @classmethod
    @overload
    def create(cls, int: int, int2: int) -> 'HashMultimap'[_create_0__K, _create_0__V]: ...
    _create_1__K = _py_TypeVar('_create_1__K')  # <K>
    _create_1__V = _py_TypeVar('_create_1__V')  # <V>
    @classmethod
    @overload
    def create(cls) -> 'HashMultimap'[_create_1__K, _create_1__V]: ...
    _create_2__K = _py_TypeVar('_create_2__K')  # <K>
    _create_2__V = _py_TypeVar('_create_2__V')  # <V>
    @classmethod
    @overload
    def create(cls, multimap: Multimap[_create_2__K, _create_2__V]) -> 'HashMultimap'[_create_2__K, _create_2__V]: ...
    @overload
...
class LinkedHashMultimap(LinkedHashMultimapGwtSerializationDependencies[_LinkedHashMultimap__K, _LinkedHashMultimap__V], _py_Generic[_LinkedHashMultimap__K, _LinkedHashMultimap__V]):
    ...
    @classmethod
    @overload
    def create(cls, int: int, int2: int) -> 'LinkedHashMultimap'[_create_1__K, _create_1__V]: ...
    _create_2__K = _py_TypeVar('_create_2__K')  # <K>
    _create_2__V = _py_TypeVar('_create_2__V')  # <V>
    @classmethod
    @overload
    def create(cls, multimap: Multimap[_create_2__K, _create_2__V]) -> 'LinkedHashMultimap'[_create_2__K, _create_2__V]: ...
    @overload
    def entries(self) -> java.util.Collection: ...
    @overload
...
class TreeMultimap(AbstractSortedKeySortedSetMultimap[_TreeMultimap__K, _TreeMultimap__V], _py_Generic[_TreeMultimap__K, _TreeMultimap__V]):
    ...
    @classmethod
    @overload
    def create(cls, multimap: Multimap[_create_0__K, _create_0__V]) -> 'TreeMultimap'[_create_0__K, _create_0__V]: ...
    _create_1__K = _py_TypeVar('_create_1__K')  # <K>
    _create_1__V = _py_TypeVar('_create_1__V')  # <V>
    @classmethod
    @overload
    def create(cls, comparator: java.util.Comparator[_create_1__K], comparator2: java.util.Comparator[_create_1__V]) -> 'TreeMultimap'[_create_1__K, _create_1__V]: ...
    _create_2__K = _py_TypeVar('_create_2__K', bound=java.lang.Comparable)  # <K>
    _create_2__V = _py_TypeVar('_create_2__V', bound=java.lang.Comparable)  # <V>
    @classmethod
    @overload
    def create(cls) -> 'TreeMultimap'[_create_2__K, _create_2__V]: ...
    @overload
    def entries(self) -> java.util.Set: ...
    @overload
    def entries(self) -> java.util.Collection: ...
...
class ContiguousSet(com.google.common.collect.ImmutableSortedSet[_ContiguousSet__C], _py_Generic[_ContiguousSet__C]):
    ...
    @classmethod
    @overload
    def builder(cls) -> 'ImmutableSortedSet.Builder'[_builder_0__E]: ...
    _builder_1__E = _py_TypeVar('_builder_1__E')  # <E>
    @classmethod
    @overload
    def builder(cls) -> 'ImmutableSet.Builder'[_builder_1__E]: ...
    @classmethod
    @overload
...
class HashBiMap(com.google.common.collect.Maps.IteratorBasedAbstractMap[_HashBiMap__K, _HashBiMap__V], BiMap[_HashBiMap__K, _HashBiMap__V], java.io.Serializable, _py_Generic[_HashBiMap__K, _HashBiMap__V]):
    ...
    @classmethod
    @overload
    def create(cls, int: int) -> 'HashBiMap'[_create_0__K, _create_0__V]: ...
    _create_1__K = _py_TypeVar('_create_1__K')  # <K>
    _create_1__V = _py_TypeVar('_create_1__V')  # <V>
    @classmethod
    @overload
    def create(cls) -> 'HashBiMap'[_create_1__K, _create_1__V]: ...
    _create_2__K = _py_TypeVar('_create_2__K')  # <K>
    _create_2__V = _py_TypeVar('_create_2__V')  # <V>
    @classmethod
    @overload
...
class ImmutableBiMap(ImmutableBiMapFauxverideShim[_ImmutableBiMap__K, _ImmutableBiMap__V], BiMap[_ImmutableBiMap__K, _ImmutableBiMap__V], _py_Generic[_ImmutableBiMap__K, _ImmutableBiMap__V]):
    ...
    @classmethod
    @overload
    def copyOf(cls, map: java.util.Map[_copyOf_0__K, _copyOf_0__V]) -> 'ImmutableBiMap'[_copyOf_0__K, _copyOf_0__V]: ...
    _copyOf_1__K = _py_TypeVar('_copyOf_1__K')  # <K>
    _copyOf_1__V = _py_TypeVar('_copyOf_1__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[java.util.Map.Entry[_copyOf_1__K, _copyOf_1__V]]) -> 'ImmutableBiMap'[_copyOf_1__K, _copyOf_1__V]: ...
    ...
    @classmethod
    @overload
    def of(cls, k: _of_0__K, v: _of_0__V, k2: _of_0__K, v2: _of_0__V, k3: _of_0__K, v3: _of_0__V, k4: _of_0__K, v4: _of_0__V, k5: _of_0__K, v5: _of_0__V) -> 'ImmutableBiMap'[_of_0__K, _of_0__V]: ...
    _of_1__K = _py_TypeVar('_of_1__K')  # <K>
    _of_1__V = _py_TypeVar('_of_1__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_1__K, v: _of_1__V, k2: _of_1__K, v2: _of_1__V) -> 'ImmutableBiMap'[_of_1__K, _of_1__V]: ...
    _of_2__K = _py_TypeVar('_of_2__K')  # <K>
    _of_2__V = _py_TypeVar('_of_2__V')  # <V>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableBiMap'[_of_2__K, _of_2__V]: ...
    _of_3__K = _py_TypeVar('_of_3__K')  # <K>
    _of_3__V = _py_TypeVar('_of_3__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, k: _of_5__K, v: _of_5__V) -> 'ImmutableBiMap'[_of_5__K, _of_5__V]: ...
    _of_6__K = _py_TypeVar('_of_6__K')  # <K>
    _of_6__V = _py_TypeVar('_of_6__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, k: _of_7__K, v: _of_7__V, k2: _of_7__K, v2: _of_7__V, k3: _of_7__K, v3: _of_7__V, k4: _of_7__K, v4: _of_7__V) -> ImmutableMap[_of_7__K, _of_7__V]: ...
    _of_8__K = _py_TypeVar('_of_8__K')  # <K>
    _of_8__V = _py_TypeVar('_of_8__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_8__K, v: _of_8__V, k2: _of_8__K, v2: _of_8__V, k3: _of_8__K, v3: _of_8__V, k4: _of_8__K, v4: _of_8__V, k5: _of_8__K, v5: _of_8__V) -> ImmutableMap[_of_8__K, _of_8__V]: ...
    _of_9__K = _py_TypeVar('_of_9__K')  # <K>
    _of_9__V = _py_TypeVar('_of_9__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, k: _of_10__K, v: _of_10__V) -> ImmutableMap[_of_10__K, _of_10__V]: ...
    _of_11__K = _py_TypeVar('_of_11__K')  # <K>
    _of_11__V = _py_TypeVar('_of_11__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_11__K, v: _of_11__V, k2: _of_11__K, v2: _of_11__V) -> ImmutableMap[_of_11__K, _of_11__V]: ...
...
class ImmutableList(ImmutableCollection[_ImmutableList__E], java.util.List[_ImmutableList__E], java.util.RandomAccess, _py_Generic[_ImmutableList__E]):
    ...
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_0__E]) -> 'ImmutableList'[_copyOf_0__E]: ...
    _copyOf_1__E = _py_TypeVar('_copyOf_1__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterator: java.util.Iterator[_copyOf_1__E]) -> 'ImmutableList'[_copyOf_1__E]: ...
    ...
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_3__E]) -> 'ImmutableList'[_copyOf_3__E]: ...
    def equals(self, object: _py_Any) -> bool: ...
    ...
    @classmethod
    @overload
    def of(cls, e: _of_1__E, e2: _of_1__E) -> 'ImmutableList'[_of_1__E]: ...
    _of_2__E = _py_TypeVar('_of_2__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_2__E, e2: _of_2__E, e3: _of_2__E) -> 'ImmutableList'[_of_2__E]: ...
    _of_3__E = _py_TypeVar('_of_3__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_3__E) -> 'ImmutableList'[_of_3__E]: ...
    ...
    @classmethod
    @overload
    def of(cls, e: _of_5__E, e2: _of_5__E, e3: _of_5__E, e4: _of_5__E, e5: _of_5__E, e6: _of_5__E, e7: _of_5__E, e8: _of_5__E, e9: _of_5__E) -> 'ImmutableList'[_of_5__E]: ...
    _of_6__E = _py_TypeVar('_of_6__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_6__E, e2: _of_6__E, e3: _of_6__E, e4: _of_6__E, e5: _of_6__E, e6: _of_6__E, e7: _of_6__E, e8: _of_6__E, e9: _of_6__E, e10: _of_6__E, e11: _of_6__E, e12: _of_6__E, eArray: _py_List[_of_6__E]) -> 'ImmutableList'[_of_6__E]: ...
    _of_7__E = _py_TypeVar('_of_7__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_7__E, e2: _of_7__E, e3: _of_7__E, e4: _of_7__E, e5: _of_7__E, e6: _of_7__E, e7: _of_7__E, e8: _of_7__E, e9: _of_7__E, e10: _of_7__E) -> 'ImmutableList'[_of_7__E]: ...
    _of_8__E = _py_TypeVar('_of_8__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_8__E, e2: _of_8__E, e3: _of_8__E, e4: _of_8__E, e5: _of_8__E, e6: _of_8__E, e7: _of_8__E, e8: _of_8__E, e9: _of_8__E, e10: _of_8__E, e11: _of_8__E) -> 'ImmutableList'[_of_8__E]: ...
    _of_9__E = _py_TypeVar('_of_9__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_9__E, e2: _of_9__E, e3: _of_9__E, e4: _of_9__E, e5: _of_9__E) -> 'ImmutableList'[_of_9__E]: ...
    _of_10__E = _py_TypeVar('_of_10__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_10__E, e2: _of_10__E, e3: _of_10__E, e4: _of_10__E, e5: _of_10__E, e6: _of_10__E) -> 'ImmutableList'[_of_10__E]: ...
    _of_11__E = _py_TypeVar('_of_11__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_11__E, e2: _of_11__E, e3: _of_11__E, e4: _of_11__E, e5: _of_11__E, e6: _of_11__E, e7: _of_11__E) -> 'ImmutableList'[_of_11__E]: ...
    _of_12__E = _py_TypeVar('_of_12__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_12__E, e2: _of_12__E, e3: _of_12__E, e4: _of_12__E, e5: _of_12__E, e6: _of_12__E, e7: _of_12__E, e8: _of_12__E) -> 'ImmutableList'[_of_12__E]: ...
    @overload
...
class ImmutableListMultimap(ImmutableMultimap[_ImmutableListMultimap__K, _ImmutableListMultimap__V], ListMultimap[_ImmutableListMultimap__K, _ImmutableListMultimap__V], _py_Generic[_ImmutableListMultimap__K, _ImmutableListMultimap__V]):
    ...
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[java.util.Map.Entry[_copyOf_0__K, _copyOf_0__V]]) -> 'ImmutableListMultimap'[_copyOf_0__K, _copyOf_0__V]: ...
    _copyOf_1__K = _py_TypeVar('_copyOf_1__K')  # <K>
    _copyOf_1__V = _py_TypeVar('_copyOf_1__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, multimap: Multimap[_copyOf_1__K, _copyOf_1__V]) -> 'ImmutableListMultimap'[_copyOf_1__K, _copyOf_1__V]: ...
    _copyOf_2__K = _py_TypeVar('_copyOf_2__K')  # <K>
    _copyOf_2__V = _py_TypeVar('_copyOf_2__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[java.util.Map.Entry[_copyOf_2__K, _copyOf_2__V]]) -> ImmutableMultimap[_copyOf_2__K, _copyOf_2__V]: ...
    _copyOf_3__K = _py_TypeVar('_copyOf_3__K')  # <K>
    _copyOf_3__V = _py_TypeVar('_copyOf_3__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, multimap: Multimap[_copyOf_3__K, _copyOf_3__V]) -> ImmutableMultimap[_copyOf_3__K, _copyOf_3__V]: ...
    ...
    @classmethod
    @overload
    def of(cls, k: _of_0__K, v: _of_0__V, k2: _of_0__K, v2: _of_0__V, k3: _of_0__K, v3: _of_0__V) -> 'ImmutableListMultimap'[_of_0__K, _of_0__V]: ...
    _of_1__K = _py_TypeVar('_of_1__K')  # <K>
    _of_1__V = _py_TypeVar('_of_1__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, k: _of_3__K, v: _of_3__V, k2: _of_3__K, v2: _of_3__V, k3: _of_3__K, v3: _of_3__V, k4: _of_3__K, v4: _of_3__V) -> 'ImmutableListMultimap'[_of_3__K, _of_3__V]: ...
    _of_4__K = _py_TypeVar('_of_4__K')  # <K>
    _of_4__V = _py_TypeVar('_of_4__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_4__K, v: _of_4__V, k2: _of_4__K, v2: _of_4__V, k3: _of_4__K, v3: _of_4__V, k4: _of_4__K, v4: _of_4__V, k5: _of_4__K, v5: _of_4__V) -> 'ImmutableListMultimap'[_of_4__K, _of_4__V]: ...
    _of_5__K = _py_TypeVar('_of_5__K')  # <K>
    _of_5__V = _py_TypeVar('_of_5__V')  # <V>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableListMultimap'[_of_5__K, _of_5__V]: ...
    _of_6__K = _py_TypeVar('_of_6__K')  # <K>
    _of_6__V = _py_TypeVar('_of_6__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, k: _of_8__K, v: _of_8__V, k2: _of_8__K, v2: _of_8__V, k3: _of_8__K, v3: _of_8__V, k4: _of_8__K, v4: _of_8__V) -> ImmutableMultimap[_of_8__K, _of_8__V]: ...
    _of_9__K = _py_TypeVar('_of_9__K')  # <K>
    _of_9__V = _py_TypeVar('_of_9__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_9__K, v: _of_9__V, k2: _of_9__K, v2: _of_9__V, k3: _of_9__K, v3: _of_9__V, k4: _of_9__K, v4: _of_9__V, k5: _of_9__K, v5: _of_9__V) -> ImmutableMultimap[_of_9__K, _of_9__V]: ...
    _of_10__K = _py_TypeVar('_of_10__K')  # <K>
    _of_10__V = _py_TypeVar('_of_10__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_10__K, v: _of_10__V, k2: _of_10__K, v2: _of_10__V) -> ImmutableMultimap[_of_10__K, _of_10__V]: ...
    _of_11__K = _py_TypeVar('_of_11__K')  # <K>
    _of_11__V = _py_TypeVar('_of_11__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_11__K, v: _of_11__V, k2: _of_11__K, v2: _of_11__V, k3: _of_11__K, v3: _of_11__V) -> ImmutableMultimap[_of_11__K, _of_11__V]: ...
    @overload
...
class ImmutableMultiset(ImmutableMultisetGwtSerializationDependencies[_ImmutableMultiset__E], Multiset[_ImmutableMultiset__E], _py_Generic[_ImmutableMultiset__E]):
    ...
    @classmethod
    @overload
    def copyOf(cls, iterator: java.util.Iterator[_copyOf_0__E]) -> 'ImmutableMultiset'[_copyOf_0__E]: ...
    _copyOf_1__E = _py_TypeVar('_copyOf_1__E')  # <E>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_2__E]) -> 'ImmutableMultiset'[_copyOf_2__E]: ...
    @overload
    def elementSet(self) -> java.util.Set: ...
    @overload
    ...
    @classmethod
    @overload
    def of(cls, e: _of_0__E, e2: _of_0__E) -> 'ImmutableMultiset'[_of_0__E]: ...
    _of_1__E = _py_TypeVar('_of_1__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_1__E, e2: _of_1__E, e3: _of_1__E) -> 'ImmutableMultiset'[_of_1__E]: ...
    _of_2__E = _py_TypeVar('_of_2__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_2__E) -> 'ImmutableMultiset'[_of_2__E]: ...
    _of_3__E = _py_TypeVar('_of_3__E')  # <E>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableMultiset'[_of_3__E]: ...
    _of_4__E = _py_TypeVar('_of_4__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_4__E, e2: _of_4__E, e3: _of_4__E, e4: _of_4__E, e5: _of_4__E, e6: _of_4__E, eArray: _py_List[_of_4__E]) -> 'ImmutableMultiset'[_of_4__E]: ...
    _of_5__E = _py_TypeVar('_of_5__E')  # <E>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, e: _of_6__E, e2: _of_6__E, e3: _of_6__E, e4: _of_6__E) -> 'ImmutableMultiset'[_of_6__E]: ...
    @overload
    def remove(self, object: _py_Any, int: int) -> int: ...
    @overload
    def remove(self, object: _py_Any) -> bool: ...
    ...
    _toImmutableMultiset_0__T = _py_TypeVar('_toImmutableMultiset_0__T')  # <T>
    _toImmutableMultiset_0__E = _py_TypeVar('_toImmutableMultiset_0__E')  # <E>
    @classmethod
    @overload
    def toImmutableMultiset(cls, function: java.util.function.Function[_toImmutableMultiset_0__T, _toImmutableMultiset_0__E], toIntFunction: java.util.function.ToIntFunction[_toImmutableMultiset_0__T]) -> java.util.stream.Collector[_toImmutableMultiset_0__T, _py_Any, 'ImmutableMultiset'[_toImmutableMultiset_0__E]]: ...
    _toImmutableMultiset_1__E = _py_TypeVar('_toImmutableMultiset_1__E')  # <E>
    @classmethod
    @overload
    def toImmutableMultiset(cls) -> java.util.stream.Collector[_toImmutableMultiset_1__E, _py_Any, 'ImmutableMultiset'[_toImmutableMultiset_1__E]]: ...
    def toString(self) -> str: ...
...
class ImmutableSet(ImmutableCollection[_ImmutableSet__E], java.util.Set[_ImmutableSet__E], _py_Generic[_ImmutableSet__E]):
    ...
    @classmethod
    @overload
    def copyOf(cls, collection: java.util.Collection[_copyOf_0__E]) -> 'ImmutableSet'[_copyOf_0__E]: ...
    _copyOf_1__E = _py_TypeVar('_copyOf_1__E')  # <E>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_2__E]) -> 'ImmutableSet'[_copyOf_2__E]: ...
    _copyOf_3__E = _py_TypeVar('_copyOf_3__E')  # <E>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, e: _of_0__E, e2: _of_0__E) -> 'ImmutableSet'[_of_0__E]: ...
    _of_1__E = _py_TypeVar('_of_1__E')  # <E>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls) -> 'ImmutableSet'[_of_2__E]: ...
    _of_3__E = _py_TypeVar('_of_3__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_3__E, e2: _of_3__E, e3: _of_3__E, e4: _of_3__E, e5: _of_3__E, e6: _of_3__E, eArray: _py_List[_of_3__E]) -> 'ImmutableSet'[_of_3__E]: ...
    _of_4__E = _py_TypeVar('_of_4__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_4__E, e2: _of_4__E, e3: _of_4__E, e4: _of_4__E, e5: _of_4__E) -> 'ImmutableSet'[_of_4__E]: ...
    _of_5__E = _py_TypeVar('_of_5__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_5__E, e2: _of_5__E, e3: _of_5__E, e4: _of_5__E) -> 'ImmutableSet'[_of_5__E]: ...
    _of_6__E = _py_TypeVar('_of_6__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_6__E, e2: _of_6__E, e3: _of_6__E) -> 'ImmutableSet'[_of_6__E]: ...
...
class ImmutableSetMultimap(ImmutableMultimap[_ImmutableSetMultimap__K, _ImmutableSetMultimap__V], SetMultimap[_ImmutableSetMultimap__K, _ImmutableSetMultimap__V], _py_Generic[_ImmutableSetMultimap__K, _ImmutableSetMultimap__V]):
    ...
    @classmethod
    @overload
    def builder(cls) -> 'ImmutableSetMultimap.Builder'[_builder_0__K, _builder_0__V]: ...
    _builder_1__K = _py_TypeVar('_builder_1__K')  # <K>
    _builder_1__V = _py_TypeVar('_builder_1__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[java.util.Map.Entry[_copyOf_0__K, _copyOf_0__V]]) -> 'ImmutableSetMultimap'[_copyOf_0__K, _copyOf_0__V]: ...
    _copyOf_1__K = _py_TypeVar('_copyOf_1__K')  # <K>
    _copyOf_1__V = _py_TypeVar('_copyOf_1__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, multimap: Multimap[_copyOf_1__K, _copyOf_1__V]) -> 'ImmutableSetMultimap'[_copyOf_1__K, _copyOf_1__V]: ...
    _copyOf_2__K = _py_TypeVar('_copyOf_2__K')  # <K>
    _copyOf_2__V = _py_TypeVar('_copyOf_2__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, k: _of_0__K, v: _of_0__V, k2: _of_0__K, v2: _of_0__V, k3: _of_0__K, v3: _of_0__V) -> 'ImmutableSetMultimap'[_of_0__K, _of_0__V]: ...
    _of_1__K = _py_TypeVar('_of_1__K')  # <K>
    _of_1__V = _py_TypeVar('_of_1__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_1__K, v: _of_1__V, k2: _of_1__K, v2: _of_1__V, k3: _of_1__K, v3: _of_1__V, k4: _of_1__K, v4: _of_1__V) -> 'ImmutableSetMultimap'[_of_1__K, _of_1__V]: ...
    _of_2__K = _py_TypeVar('_of_2__K')  # <K>
    _of_2__V = _py_TypeVar('_of_2__V')  # <V>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableSetMultimap'[_of_2__K, _of_2__V]: ...
    _of_3__K = _py_TypeVar('_of_3__K')  # <K>
    _of_3__V = _py_TypeVar('_of_3__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_3__K, v: _of_3__V) -> 'ImmutableSetMultimap'[_of_3__K, _of_3__V]: ...
    _of_4__K = _py_TypeVar('_of_4__K')  # <K>
    _of_4__V = _py_TypeVar('_of_4__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_4__K, v: _of_4__V, k2: _of_4__K, v2: _of_4__V, k3: _of_4__K, v3: _of_4__V, k4: _of_4__K, v4: _of_4__V, k5: _of_4__K, v5: _of_4__V) -> 'ImmutableSetMultimap'[_of_4__K, _of_4__V]: ...
    _of_5__K = _py_TypeVar('_of_5__K')  # <K>
    _of_5__V = _py_TypeVar('_of_5__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_5__K, v: _of_5__V, k2: _of_5__K, v2: _of_5__V) -> 'ImmutableSetMultimap'[_of_5__K, _of_5__V]: ...
    _of_6__K = _py_TypeVar('_of_6__K')  # <K>
    _of_6__V = _py_TypeVar('_of_6__V')  # <V>
    @classmethod
    @overload
...
class ImmutableSortedMap(ImmutableSortedMapFauxverideShim[_ImmutableSortedMap__K, _ImmutableSortedMap__V], java.util.NavigableMap[_ImmutableSortedMap__K, _ImmutableSortedMap__V], _py_Generic[_ImmutableSortedMap__K, _ImmutableSortedMap__V]):
    ...
    @classmethod
    @overload
    def copyOf(cls, map: java.util.Map[_copyOf_0__K, _copyOf_0__V]) -> 'ImmutableSortedMap'[_copyOf_0__K, _copyOf_0__V]: ...
    _copyOf_1__K = _py_TypeVar('_copyOf_1__K')  # <K>
    _copyOf_1__V = _py_TypeVar('_copyOf_1__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[java.util.Map.Entry[_copyOf_1__K, _copyOf_1__V]], comparator: java.util.Comparator[_copyOf_1__K]) -> 'ImmutableSortedMap'[_copyOf_1__K, _copyOf_1__V]: ...
    _copyOf_2__K = _py_TypeVar('_copyOf_2__K')  # <K>
    _copyOf_2__V = _py_TypeVar('_copyOf_2__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, map: java.util.Map[_copyOf_2__K, _copyOf_2__V], comparator: java.util.Comparator[_copyOf_2__K]) -> 'ImmutableSortedMap'[_copyOf_2__K, _copyOf_2__V]: ...
    _copyOf_3__K = _py_TypeVar('_copyOf_3__K')  # <K>
    _copyOf_3__V = _py_TypeVar('_copyOf_3__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[java.util.Map.Entry[_copyOf_3__K, _copyOf_3__V]]) -> 'ImmutableSortedMap'[_copyOf_3__K, _copyOf_3__V]: ...
    _copyOf_4__K = _py_TypeVar('_copyOf_4__K')  # <K>
    _copyOf_4__V = _py_TypeVar('_copyOf_4__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[java.util.Map.Entry[_copyOf_4__K, _copyOf_4__V]]) -> ImmutableMap[_copyOf_4__K, _copyOf_4__V]: ...
    _copyOf_5__K = _py_TypeVar('_copyOf_5__K')  # <K>
    _copyOf_5__V = _py_TypeVar('_copyOf_5__V')  # <V>
    @classmethod
    @overload
    def copyOf(cls, map: java.util.Map[_copyOf_5__K, _copyOf_5__V]) -> ImmutableMap[_copyOf_5__K, _copyOf_5__V]: ...
    ...
    @classmethod
    @overload
    def of(cls, k: _of_0__K, v: _of_0__V) -> 'ImmutableSortedMap'[_of_0__K, _of_0__V]: ...
    _of_1__K = _py_TypeVar('_of_1__K')  # <K>
    _of_1__V = _py_TypeVar('_of_1__V')  # <V>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableSortedMap'[_of_1__K, _of_1__V]: ...
    _of_2__K = _py_TypeVar('_of_2__K', bound=java.lang.Comparable)  # <K>
    _of_2__V = _py_TypeVar('_of_2__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_2__K, v: _of_2__V, k2: _of_2__K, v2: _of_2__V, k3: _of_2__K, v3: _of_2__V) -> 'ImmutableSortedMap'[_of_2__K, _of_2__V]: ...
    _of_3__K = _py_TypeVar('_of_3__K', bound=java.lang.Comparable)  # <K>
    _of_3__V = _py_TypeVar('_of_3__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_3__K, v: _of_3__V, k2: _of_3__K, v2: _of_3__V, k3: _of_3__K, v3: _of_3__V, k4: _of_3__K, v4: _of_3__V) -> 'ImmutableSortedMap'[_of_3__K, _of_3__V]: ...
    _of_4__K = _py_TypeVar('_of_4__K', bound=java.lang.Comparable)  # <K>
    _of_4__V = _py_TypeVar('_of_4__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_4__K, v: _of_4__V, k2: _of_4__K, v2: _of_4__V) -> 'ImmutableSortedMap'[_of_4__K, _of_4__V]: ...
    _of_5__K = _py_TypeVar('_of_5__K', bound=java.lang.Comparable)  # <K>
    _of_5__V = _py_TypeVar('_of_5__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_5__K, v: _of_5__V, k2: _of_5__K, v2: _of_5__V, k3: _of_5__K, v3: _of_5__V, k4: _of_5__K, v4: _of_5__V, k5: _of_5__K, v5: _of_5__V) -> 'ImmutableSortedMap'[_of_5__K, _of_5__V]: ...
    _of_6__K = _py_TypeVar('_of_6__K')  # <K>
    _of_6__V = _py_TypeVar('_of_6__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_6__K, v: _of_6__V, k2: _of_6__K, v2: _of_6__V, k3: _of_6__K, v3: _of_6__V, k4: _of_6__K, v4: _of_6__V, k5: _of_6__K, v5: _of_6__V) -> 'ImmutableSortedMap'[_of_6__K, _of_6__V]: ...
    _of_7__K = _py_TypeVar('_of_7__K')  # <K>
    _of_7__V = _py_TypeVar('_of_7__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_7__K, v: _of_7__V, k2: _of_7__K, v2: _of_7__V, k3: _of_7__K, v3: _of_7__V, k4: _of_7__K, v4: _of_7__V) -> 'ImmutableSortedMap'[_of_7__K, _of_7__V]: ...
    _of_8__K = _py_TypeVar('_of_8__K')  # <K>
    _of_8__V = _py_TypeVar('_of_8__V')  # <V>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, k: _of_9__K, v: _of_9__V, k2: _of_9__K, v2: _of_9__V) -> 'ImmutableSortedMap'[_of_9__K, _of_9__V]: ...
    _of_10__K = _py_TypeVar('_of_10__K')  # <K>
    _of_10__V = _py_TypeVar('_of_10__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_10__K, v: _of_10__V) -> 'ImmutableSortedMap'[_of_10__K, _of_10__V]: ...
    _of_11__K = _py_TypeVar('_of_11__K')  # <K>
    _of_11__V = _py_TypeVar('_of_11__V')  # <V>
    @classmethod
    @overload
    def of(cls) -> ImmutableMap[_of_11__K, _of_11__V]: ...
    _of_12__K = _py_TypeVar('_of_12__K')  # <K>
    _of_12__V = _py_TypeVar('_of_12__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_12__K, v: _of_12__V, k2: _of_12__K, v2: _of_12__V, k3: _of_12__K, v3: _of_12__V, k4: _of_12__K, v4: _of_12__V) -> ImmutableMap[_of_12__K, _of_12__V]: ...
    _of_13__K = _py_TypeVar('_of_13__K')  # <K>
    _of_13__V = _py_TypeVar('_of_13__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_13__K, v: _of_13__V, k2: _of_13__K, v2: _of_13__V, k3: _of_13__K, v3: _of_13__V, k4: _of_13__K, v4: _of_13__V, k5: _of_13__K, v5: _of_13__V) -> ImmutableMap[_of_13__K, _of_13__V]: ...
    _of_14__K = _py_TypeVar('_of_14__K')  # <K>
    _of_14__V = _py_TypeVar('_of_14__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_14__K, v: _of_14__V, k2: _of_14__K, v2: _of_14__V, k3: _of_14__K, v3: _of_14__V) -> ImmutableMap[_of_14__K, _of_14__V]: ...
    _of_15__K = _py_TypeVar('_of_15__K')  # <K>
    _of_15__V = _py_TypeVar('_of_15__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_15__K, v: _of_15__V) -> ImmutableMap[_of_15__K, _of_15__V]: ...
    _of_16__K = _py_TypeVar('_of_16__K')  # <K>
    _of_16__V = _py_TypeVar('_of_16__V')  # <V>
    @classmethod
    @overload
    def of(cls, k: _of_16__K, v: _of_16__V, k2: _of_16__K, v2: _of_16__V) -> ImmutableMap[_of_16__K, _of_16__V]: ...
...
class ImmutableSortedMultiset(com.google.common.collect.ImmutableSortedMultisetFauxverideShim[_ImmutableSortedMultiset__E], SortedMultiset[_ImmutableSortedMultiset__E], _py_Generic[_ImmutableSortedMultiset__E]):
    ...
    _copyOf_0__E = _py_TypeVar('_copyOf_0__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_0__E]) -> 'ImmutableSortedMultiset'[_copyOf_0__E]: ...
    _copyOf_1__E = _py_TypeVar('_copyOf_1__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, comparator: java.util.Comparator[_copyOf_1__E], iterable: java.lang.Iterable[_copyOf_1__E]) -> 'ImmutableSortedMultiset'[_copyOf_1__E]: ...
    _copyOf_2__E = _py_TypeVar('_copyOf_2__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, comparator: java.util.Comparator[_copyOf_2__E], iterator: java.util.Iterator[_copyOf_2__E]) -> 'ImmutableSortedMultiset'[_copyOf_2__E]: ...
    _copyOf_3__E = _py_TypeVar('_copyOf_3__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_3__E]) -> 'ImmutableSortedMultiset'[_copyOf_3__E]: ...
    _copyOf_4__E = _py_TypeVar('_copyOf_4__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterator: java.util.Iterator[_copyOf_4__E]) -> 'ImmutableSortedMultiset'[_copyOf_4__E]: ...
    _copyOf_5__E = _py_TypeVar('_copyOf_5__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_5__E]) -> 'ImmutableSortedMultiset'[_copyOf_5__E]: ...
    _copyOf_6__E = _py_TypeVar('_copyOf_6__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterator: java.util.Iterator[_copyOf_6__E]) -> ImmutableMultiset[_copyOf_6__E]: ...
    _copyOf_7__E = _py_TypeVar('_copyOf_7__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_7__E]) -> ImmutableMultiset[_copyOf_7__E]: ...
    _copyOf_8__E = _py_TypeVar('_copyOf_8__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_8__E]) -> ImmutableMultiset[_copyOf_8__E]: ...
    ...
    _of_0__E = _py_TypeVar('_of_0__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_0__E, e2: _of_0__E, e3: _of_0__E) -> 'ImmutableSortedMultiset'[_of_0__E]: ...
    _of_1__E = _py_TypeVar('_of_1__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_1__E, e2: _of_1__E, e3: _of_1__E, e4: _of_1__E) -> 'ImmutableSortedMultiset'[_of_1__E]: ...
    _of_2__E = _py_TypeVar('_of_2__E')  # <E>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableSortedMultiset'[_of_2__E]: ...
    _of_3__E = _py_TypeVar('_of_3__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_3__E) -> 'ImmutableSortedMultiset'[_of_3__E]: ...
    _of_4__E = _py_TypeVar('_of_4__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_4__E, e2: _of_4__E) -> 'ImmutableSortedMultiset'[_of_4__E]: ...
    _of_5__E = _py_TypeVar('_of_5__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_5__E, e2: _of_5__E, e3: _of_5__E, e4: _of_5__E, e5: _of_5__E, e6: _of_5__E, eArray: _py_List[_of_5__E]) -> 'ImmutableSortedMultiset'[_of_5__E]: ...
    _of_6__E = _py_TypeVar('_of_6__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_6__E, e2: _of_6__E, e3: _of_6__E, e4: _of_6__E, e5: _of_6__E) -> 'ImmutableSortedMultiset'[_of_6__E]: ...
    _of_7__E = _py_TypeVar('_of_7__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_7__E, e2: _of_7__E) -> 'ImmutableSortedMultiset'[_of_7__E]: ...
    _of_8__E = _py_TypeVar('_of_8__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_8__E, e2: _of_8__E, e3: _of_8__E, e4: _of_8__E, e5: _of_8__E, e6: _of_8__E, eArray: _py_List[_of_8__E]) -> 'ImmutableSortedMultiset'[_of_8__E]: ...
    _of_9__E = _py_TypeVar('_of_9__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_9__E, e2: _of_9__E, e3: _of_9__E, e4: _of_9__E, e5: _of_9__E) -> 'ImmutableSortedMultiset'[_of_9__E]: ...
    _of_10__E = _py_TypeVar('_of_10__E')  # <E>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, e: _of_11__E, e2: _of_11__E, e3: _of_11__E) -> 'ImmutableSortedMultiset'[_of_11__E]: ...
    _of_12__E = _py_TypeVar('_of_12__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_12__E) -> 'ImmutableSortedMultiset'[_of_12__E]: ...
    _of_13__E = _py_TypeVar('_of_13__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_13__E, e2: _of_13__E) -> ImmutableMultiset[_of_13__E]: ...
    _of_14__E = _py_TypeVar('_of_14__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_14__E, e2: _of_14__E, e3: _of_14__E) -> ImmutableMultiset[_of_14__E]: ...
    _of_15__E = _py_TypeVar('_of_15__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_15__E) -> ImmutableMultiset[_of_15__E]: ...
    _of_16__E = _py_TypeVar('_of_16__E')  # <E>
    @classmethod
    @overload
    def of(cls) -> ImmutableMultiset[_of_16__E]: ...
    _of_17__E = _py_TypeVar('_of_17__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_17__E, e2: _of_17__E, e3: _of_17__E, e4: _of_17__E, e5: _of_17__E, e6: _of_17__E, eArray: _py_List[_of_17__E]) -> ImmutableMultiset[_of_17__E]: ...
    _of_18__E = _py_TypeVar('_of_18__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_18__E, e2: _of_18__E, e3: _of_18__E, e4: _of_18__E, e5: _of_18__E) -> ImmutableMultiset[_of_18__E]: ...
    _of_19__E = _py_TypeVar('_of_19__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_19__E, e2: _of_19__E, e3: _of_19__E, e4: _of_19__E) -> ImmutableMultiset[_of_19__E]: ...
    ...
    @overload
    def tailMultiset(self, object: _py_Any, boundType: BoundType) -> SortedMultiset: ...
    _toImmutableSortedMultiset_0__T = _py_TypeVar('_toImmutableSortedMultiset_0__T')  # <T>
    _toImmutableSortedMultiset_0__E = _py_TypeVar('_toImmutableSortedMultiset_0__E')  # <E>
    @classmethod
    @overload
    def toImmutableSortedMultiset(cls, comparator: java.util.Comparator[_toImmutableSortedMultiset_0__E], function: java.util.function.Function[_toImmutableSortedMultiset_0__T, _toImmutableSortedMultiset_0__E], toIntFunction: java.util.function.ToIntFunction[_toImmutableSortedMultiset_0__T]) -> java.util.stream.Collector[_toImmutableSortedMultiset_0__T, _py_Any, 'ImmutableSortedMultiset'[_toImmutableSortedMultiset_0__E]]: ...
    _toImmutableSortedMultiset_1__E = _py_TypeVar('_toImmutableSortedMultiset_1__E')  # <E>
    @classmethod
    @overload
    def toImmutableSortedMultiset(cls, comparator: java.util.Comparator[_toImmutableSortedMultiset_1__E]) -> java.util.stream.Collector[_toImmutableSortedMultiset_1__E, _py_Any, 'ImmutableSortedMultiset'[_toImmutableSortedMultiset_1__E]]: ...
...
class ImmutableSortedMultisetFauxverideShim(ImmutableMultiset[_ImmutableSortedMultisetFauxverideShim__E], _py_Generic[_ImmutableSortedMultisetFauxverideShim__E]):
    ...
    @classmethod
    @overload
    def builder(cls) -> 'ImmutableSortedMultiset.Builder'[_builder_0__E]: ...
    _builder_1__E = _py_TypeVar('_builder_1__E')  # <E>
    @classmethod
    @overload
    def builder(cls) -> 'ImmutableMultiset.Builder'[_builder_1__E]: ...
    _copyOf_0__E = _py_TypeVar('_copyOf_0__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_0__E]) -> ImmutableSortedMultiset[_copyOf_0__E]: ...
    ...
    @classmethod
    @overload
    def copyOf(cls, iterator: java.util.Iterator[_copyOf_1__E]) -> ImmutableMultiset[_copyOf_1__E]: ...
    _copyOf_2__E = _py_TypeVar('_copyOf_2__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_2__E]) -> ImmutableMultiset[_copyOf_2__E]: ...
    _copyOf_3__E = _py_TypeVar('_copyOf_3__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_3__E]) -> ImmutableMultiset[_copyOf_3__E]: ...
    _of_0__E = _py_TypeVar('_of_0__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_0__E, e2: _of_0__E) -> ImmutableSortedMultiset[_of_0__E]: ...
    _of_1__E = _py_TypeVar('_of_1__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_1__E, e2: _of_1__E, e3: _of_1__E, e4: _of_1__E, e5: _of_1__E, e6: _of_1__E, eArray: _py_List[_of_1__E]) -> ImmutableSortedMultiset[_of_1__E]: ...
    _of_2__E = _py_TypeVar('_of_2__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_2__E, e2: _of_2__E, e3: _of_2__E, e4: _of_2__E, e5: _of_2__E) -> ImmutableSortedMultiset[_of_2__E]: ...
    _of_3__E = _py_TypeVar('_of_3__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_3__E, e2: _of_3__E, e3: _of_3__E, e4: _of_3__E) -> ImmutableSortedMultiset[_of_3__E]: ...
    _of_4__E = _py_TypeVar('_of_4__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_4__E, e2: _of_4__E, e3: _of_4__E) -> ImmutableSortedMultiset[_of_4__E]: ...
    _of_5__E = _py_TypeVar('_of_5__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_5__E) -> ImmutableSortedMultiset[_of_5__E]: ...
    _of_6__E = _py_TypeVar('_of_6__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_6__E, e2: _of_6__E) -> ImmutableMultiset[_of_6__E]: ...
    _of_7__E = _py_TypeVar('_of_7__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_7__E, e2: _of_7__E, e3: _of_7__E) -> ImmutableMultiset[_of_7__E]: ...
    _of_8__E = _py_TypeVar('_of_8__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_8__E) -> ImmutableMultiset[_of_8__E]: ...
    _of_9__E = _py_TypeVar('_of_9__E')  # <E>
    @classmethod
    @overload
    def of(cls) -> ImmutableMultiset[_of_9__E]: ...
    _of_10__E = _py_TypeVar('_of_10__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_10__E, e2: _of_10__E, e3: _of_10__E, e4: _of_10__E, e5: _of_10__E, e6: _of_10__E, eArray: _py_List[_of_10__E]) -> ImmutableMultiset[_of_10__E]: ...
    _of_11__E = _py_TypeVar('_of_11__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_11__E, e2: _of_11__E, e3: _of_11__E, e4: _of_11__E, e5: _of_11__E) -> ImmutableMultiset[_of_11__E]: ...
    _of_12__E = _py_TypeVar('_of_12__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_12__E, e2: _of_12__E, e3: _of_12__E, e4: _of_12__E) -> ImmutableMultiset[_of_12__E]: ...
    _toImmutableMultiset_0__E = _py_TypeVar('_toImmutableMultiset_0__E')  # <E>
    @classmethod
    @overload
...
class ImmutableSortedSet(com.google.common.collect.ImmutableSortedSetFauxverideShim[_ImmutableSortedSet__E], java.util.NavigableSet[_ImmutableSortedSet__E], SortedIterable[_ImmutableSortedSet__E], _py_Generic[_ImmutableSortedSet__E]):
    ...
    @classmethod
    @overload
    def copyOf(cls, comparator: java.util.Comparator[_copyOf_0__E], iterator: java.util.Iterator[_copyOf_0__E]) -> 'ImmutableSortedSet'[_copyOf_0__E]: ...
    _copyOf_1__E = _py_TypeVar('_copyOf_1__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_1__E]) -> 'ImmutableSortedSet'[_copyOf_1__E]: ...
    _copyOf_2__E = _py_TypeVar('_copyOf_2__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, comparator: java.util.Comparator[_copyOf_2__E], collection: java.util.Collection[_copyOf_2__E]) -> 'ImmutableSortedSet'[_copyOf_2__E]: ...
    _copyOf_3__E = _py_TypeVar('_copyOf_3__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, comparator: java.util.Comparator[_copyOf_3__E], iterable: java.lang.Iterable[_copyOf_3__E]) -> 'ImmutableSortedSet'[_copyOf_3__E]: ...
    _copyOf_4__E = _py_TypeVar('_copyOf_4__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterator: java.util.Iterator[_copyOf_4__E]) -> 'ImmutableSortedSet'[_copyOf_4__E]: ...
    _copyOf_5__E = _py_TypeVar('_copyOf_5__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, collection: java.util.Collection[_copyOf_5__E]) -> 'ImmutableSortedSet'[_copyOf_5__E]: ...
    _copyOf_6__E = _py_TypeVar('_copyOf_6__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_6__E]) -> 'ImmutableSortedSet'[_copyOf_6__E]: ...
    _copyOf_7__E = _py_TypeVar('_copyOf_7__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_7__E]) -> 'ImmutableSortedSet'[_copyOf_7__E]: ...
    _copyOf_8__E = _py_TypeVar('_copyOf_8__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, collection: java.util.Collection[_copyOf_8__E]) -> ImmutableSet[_copyOf_8__E]: ...
    _copyOf_9__E = _py_TypeVar('_copyOf_9__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_9__E]) -> ImmutableSet[_copyOf_9__E]: ...
    _copyOf_10__E = _py_TypeVar('_copyOf_10__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_10__E]) -> ImmutableSet[_copyOf_10__E]: ...
    _copyOf_11__E = _py_TypeVar('_copyOf_11__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterator: java.util.Iterator[_copyOf_11__E]) -> ImmutableSet[_copyOf_11__E]: ...
    _copyOfSorted__E = _py_TypeVar('_copyOfSorted__E')  # <E>
    @classmethod
    ...
    @classmethod
    @overload
    def of(cls, e: _of_0__E, e2: _of_0__E, e3: _of_0__E, e4: _of_0__E, e5: _of_0__E) -> 'ImmutableSortedSet'[_of_0__E]: ...
    _of_1__E = _py_TypeVar('_of_1__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_1__E, e2: _of_1__E, e3: _of_1__E, e4: _of_1__E, e5: _of_1__E, e6: _of_1__E, eArray: _py_List[_of_1__E]) -> 'ImmutableSortedSet'[_of_1__E]: ...
    _of_2__E = _py_TypeVar('_of_2__E')  # <E>
    @classmethod
    @overload
    def of(cls) -> 'ImmutableSortedSet'[_of_2__E]: ...
    _of_3__E = _py_TypeVar('_of_3__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_3__E, e2: _of_3__E, e3: _of_3__E, e4: _of_3__E) -> 'ImmutableSortedSet'[_of_3__E]: ...
    _of_4__E = _py_TypeVar('_of_4__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_4__E) -> 'ImmutableSortedSet'[_of_4__E]: ...
    _of_5__E = _py_TypeVar('_of_5__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_5__E, e2: _of_5__E, e3: _of_5__E) -> 'ImmutableSortedSet'[_of_5__E]: ...
    _of_6__E = _py_TypeVar('_of_6__E', bound=java.lang.Comparable)  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_6__E, e2: _of_6__E) -> 'ImmutableSortedSet'[_of_6__E]: ...
    _of_7__E = _py_TypeVar('_of_7__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_7__E, e2: _of_7__E) -> 'ImmutableSortedSet'[_of_7__E]: ...
    _of_8__E = _py_TypeVar('_of_8__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_8__E, e2: _of_8__E, e3: _of_8__E, e4: _of_8__E, e5: _of_8__E, e6: _of_8__E, eArray: _py_List[_of_8__E]) -> 'ImmutableSortedSet'[_of_8__E]: ...
    _of_9__E = _py_TypeVar('_of_9__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_9__E, e2: _of_9__E, e3: _of_9__E, e4: _of_9__E, e5: _of_9__E) -> 'ImmutableSortedSet'[_of_9__E]: ...
    _of_10__E = _py_TypeVar('_of_10__E')  # <E>
    @classmethod
    @overload
    ...
    @classmethod
    @overload
    def of(cls, e: _of_11__E, e2: _of_11__E, e3: _of_11__E) -> 'ImmutableSortedSet'[_of_11__E]: ...
    _of_12__E = _py_TypeVar('_of_12__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_12__E) -> 'ImmutableSortedSet'[_of_12__E]: ...
    _of_13__E = _py_TypeVar('_of_13__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_13__E, e2: _of_13__E) -> ImmutableSet[_of_13__E]: ...
    _of_14__E = _py_TypeVar('_of_14__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_14__E) -> ImmutableSet[_of_14__E]: ...
    _of_15__E = _py_TypeVar('_of_15__E')  # <E>
    @classmethod
    @overload
    def of(cls) -> ImmutableSet[_of_15__E]: ...
    _of_16__E = _py_TypeVar('_of_16__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_16__E, e2: _of_16__E, e3: _of_16__E, e4: _of_16__E, e5: _of_16__E, e6: _of_16__E, eArray: _py_List[_of_16__E]) -> ImmutableSet[_of_16__E]: ...
    _of_17__E = _py_TypeVar('_of_17__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_17__E, e2: _of_17__E, e3: _of_17__E, e4: _of_17__E, e5: _of_17__E) -> ImmutableSet[_of_17__E]: ...
    _of_18__E = _py_TypeVar('_of_18__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_18__E, e2: _of_18__E, e3: _of_18__E, e4: _of_18__E) -> ImmutableSet[_of_18__E]: ...
    _of_19__E = _py_TypeVar('_of_19__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_19__E, e2: _of_19__E, e3: _of_19__E) -> ImmutableSet[_of_19__E]: ...
    _orderedBy__E = _py_TypeVar('_orderedBy__E')  # <E>
    @classmethod
...
class ImmutableSortedSetFauxverideShim(ImmutableSet[_ImmutableSortedSetFauxverideShim__E], _py_Generic[_ImmutableSortedSetFauxverideShim__E]):
    ...
    @classmethod
    @overload
    def builderWithExpectedSize(cls, int: int) -> 'ImmutableSortedSet.Builder'[_builderWithExpectedSize_0__E]: ...
    _builderWithExpectedSize_1__E = _py_TypeVar('_builderWithExpectedSize_1__E')  # <E>
    @classmethod
    @overload
    def builderWithExpectedSize(cls, int: int) -> 'ImmutableSet.Builder'[_builderWithExpectedSize_1__E]: ...
    _copyOf_0__E = _py_TypeVar('_copyOf_0__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_0__E]) -> ImmutableSortedSet[_copyOf_0__E]: ...
    _copyOf_1__E = _py_TypeVar('_copyOf_1__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, collection: java.util.Collection[_copyOf_1__E]) -> ImmutableSet[_copyOf_1__E]: ...
    _copyOf_2__E = _py_TypeVar('_copyOf_2__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, eArray: _py_List[_copyOf_2__E]) -> ImmutableSet[_copyOf_2__E]: ...
    _copyOf_3__E = _py_TypeVar('_copyOf_3__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterable: java.lang.Iterable[_copyOf_3__E]) -> ImmutableSet[_copyOf_3__E]: ...
    _copyOf_4__E = _py_TypeVar('_copyOf_4__E')  # <E>
    @classmethod
    @overload
    def copyOf(cls, iterator: java.util.Iterator[_copyOf_4__E]) -> ImmutableSet[_copyOf_4__E]: ...
    _of_0__E = _py_TypeVar('_of_0__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_0__E, e2: _of_0__E) -> ImmutableSortedSet[_of_0__E]: ...
    _of_1__E = _py_TypeVar('_of_1__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_1__E, e2: _of_1__E, e3: _of_1__E, e4: _of_1__E, e5: _of_1__E, e6: _of_1__E, eArray: _py_List[_of_1__E]) -> ImmutableSortedSet[_of_1__E]: ...
    ...
    @classmethod
    @overload
    def of(cls, e: _of_2__E, e2: _of_2__E, e3: _of_2__E, e4: _of_2__E, e5: _of_2__E) -> ImmutableSortedSet[_of_2__E]: ...
    _of_3__E = _py_TypeVar('_of_3__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_3__E, e2: _of_3__E, e3: _of_3__E, e4: _of_3__E) -> ImmutableSortedSet[_of_3__E]: ...
    ...
    @classmethod
    @overload
    def of(cls, e: _of_4__E, e2: _of_4__E, e3: _of_4__E) -> ImmutableSortedSet[_of_4__E]: ...
    _of_5__E = _py_TypeVar('_of_5__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_5__E) -> ImmutableSortedSet[_of_5__E]: ...
    _of_6__E = _py_TypeVar('_of_6__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_6__E, e2: _of_6__E) -> ImmutableSet[_of_6__E]: ...
    _of_7__E = _py_TypeVar('_of_7__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_7__E) -> ImmutableSet[_of_7__E]: ...
    _of_8__E = _py_TypeVar('_of_8__E')  # <E>
    @classmethod
    @overload
    def of(cls) -> ImmutableSet[_of_8__E]: ...
    _of_9__E = _py_TypeVar('_of_9__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_9__E, e2: _of_9__E, e3: _of_9__E, e4: _of_9__E, e5: _of_9__E, e6: _of_9__E, eArray: _py_List[_of_9__E]) -> ImmutableSet[_of_9__E]: ...
    _of_10__E = _py_TypeVar('_of_10__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_10__E, e2: _of_10__E, e3: _of_10__E, e4: _of_10__E, e5: _of_10__E) -> ImmutableSet[_of_10__E]: ...
    _of_11__E = _py_TypeVar('_of_11__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_11__E, e2: _of_11__E, e3: _of_11__E, e4: _of_11__E) -> ImmutableSet[_of_11__E]: ...
    _of_12__E = _py_TypeVar('_of_12__E')  # <E>
    @classmethod
    @overload
    def of(cls, e: _of_12__E, e2: _of_12__E, e3: _of_12__E) -> ImmutableSet[_of_12__E]: ...
    _toImmutableSet__E = _py_TypeVar('_toImmutableSet__E')  # <E>
    @classmethod
    def toImmutableSet(cls) -> java.util.stream.Collector[_toImmutableSet__E, _py_Any, ImmutableSet[_toImmutableSet__E]]: ...
...
class MultimapBuilder(_py_Generic[_MultimapBuilder__K0, _MultimapBuilder__V0]):
    ...
    @overload
    def build(self, multimap: Multimap[_build_0__K, _build_0__V]) -> Multimap[_build_0__K, _build_0__V]: ...
    _build_1__K = _py_TypeVar('_build_1__K')  # <K>
    _build_1__V = _py_TypeVar('_build_1__V')  # <V>
    @overload
    def build(self) -> Multimap[_build_1__K, _build_1__V]: ...
    ...
    class ListMultimapBuilder(com.google.common.collect.MultimapBuilder[_MultimapBuilder__ListMultimapBuilder__K0, _MultimapBuilder__ListMultimapBuilder__V0], _py_Generic[_MultimapBuilder__ListMultimapBuilder__K0, _MultimapBuilder__ListMultimapBuilder__V0]):
        ...
        _build_2__K = _py_TypeVar('_build_2__K')  # <K>
        _build_2__V = _py_TypeVar('_build_2__V')  # <V>
        @overload
        def build(self) -> ListMultimap[_build_2__K, _build_2__V]: ...
        _build_3__K = _py_TypeVar('_build_3__K')  # <K>
        _build_3__V = _py_TypeVar('_build_3__V')  # <V>
        @overload
        def build(self, multimap: Multimap[_build_3__K, _build_3__V]) -> ListMultimap[_build_3__K, _build_3__V]: ...
    class MultimapBuilderWithKeys(_py_Generic[_MultimapBuilder__MultimapBuilderWithKeys__K0]):
        ...
        _treeSetValues_0__V0 = _py_TypeVar('_treeSetValues_0__V0')  # <V0>
        @overload
        def treeSetValues(self, comparator: java.util.Comparator[_treeSetValues_0__V0]) -> 'MultimapBuilder.SortedSetMultimapBuilder'[_MultimapBuilder__MultimapBuilderWithKeys__K0, _treeSetValues_0__V0]: ...
        @overload
    ...
    class SetMultimapBuilder(com.google.common.collect.MultimapBuilder[_MultimapBuilder__SetMultimapBuilder__K0, _MultimapBuilder__SetMultimapBuilder__V0], _py_Generic[_MultimapBuilder__SetMultimapBuilder__K0, _MultimapBuilder__SetMultimapBuilder__V0]):
        ...
        _build_2__V = _py_TypeVar('_build_2__V')  # <V>
        @overload
        def build(self) -> SetMultimap[_build_2__K, _build_2__V]: ...
        _build_3__K = _py_TypeVar('_build_3__K')  # <K>
        _build_3__V = _py_TypeVar('_build_3__V')  # <V>
        @overload
    ...
    class SortedSetMultimapBuilder(com.google.common.collect.MultimapBuilder.SetMultimapBuilder[_MultimapBuilder__SortedSetMultimapBuilder__K0, _MultimapBuilder__SortedSetMultimapBuilder__V0], _py_Generic[_MultimapBuilder__SortedSetMultimapBuilder__K0, _MultimapBuilder__SortedSetMultimapBuilder__V0]):
        ...
        _build_4__K = _py_TypeVar('_build_4__K')  # <K>
        _build_4__V = _py_TypeVar('_build_4__V')  # <V>
        @overload
        def build(self) -> SortedSetMultimap[_build_4__K, _build_4__V]: ...
