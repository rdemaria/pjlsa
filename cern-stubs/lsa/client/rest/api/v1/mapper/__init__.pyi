...
class MapperUtils:
    ...
    @classmethod
    @overload
    def safeSetCollection(cls, collection: java.util.Collection[_safeSetCollection_0__U], function: java.util.function.Function[java.util.Collection[_safeSetCollection_0__U], java.util.Collection[_safeSetCollection_0__T]], consumer: java.util.function.Consumer[java.util.Collection[_safeSetCollection_0__T]], function2: java.util.function.Function[java.util.Collection[_safeSetCollection_0__U], bool]) -> None: ...
    ...
    @classmethod
    @overload
    def safeSetCollection(cls, collection: java.util.Collection[_safeSetCollection_1__U], function: java.util.function.Function[java.util.Collection[_safeSetCollection_1__U], java.util.Collection[_safeSetCollection_1__T]], consumer: java.util.function.Consumer[java.util.Collection[_safeSetCollection_1__T]]) -> None: ...
