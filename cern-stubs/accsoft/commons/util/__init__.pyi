...
class Nameds:
    ...
    @classmethod
    @overload
    def filterByNames(cls, list: java.util.List[_filterByNames_0__T], collection: java.util.Collection[str]) -> java.util.List[_filterByNames_0__T]: ...
    _filterByNames_1__T = _py_TypeVar('_filterByNames_1__T', bound=Named)  # <T>
    @classmethod
    @overload
    def filterByNames(cls, set: java.util.Set[_filterByNames_1__T], collection: java.util.Collection[str]) -> java.util.Set[_filterByNames_1__T]: ...
    _filterByNames_2__T = _py_TypeVar('_filterByNames_2__T', bound=Named)  # <T>
    @classmethod
    @overload
    def filterByNames(cls, collection: java.util.Collection[_filterByNames_2__T], collection2: java.util.Collection[str]) -> java.util.Collection[_filterByNames_2__T]: ...
    _findByName_0__T = _py_TypeVar('_findByName_0__T', bound=Named)  # <T>
    @classmethod
    @overload
    def findByName(cls, collection: java.util.Collection[_findByName_0__T], string: str) -> _findByName_0__T: ...
    _findByName_1__T = _py_TypeVar('_findByName_1__T', bound=Named)  # <T>
    @classmethod
    @overload
    def findByName(cls, tArray: _py_List[_findByName_1__T], string: str) -> _findByName_1__T: ...
    @classmethod
    @overload
...
class Filters:
    ...
    @classmethod
    @overload
    def filter(cls, set: java.util.Set[_filter_1__T]) -> 'Filters.FilterSourceCollectionHolder'[_filter_1__T, java.util.Set[_filter_1__T]]: ...
    _filter_2__T = _py_TypeVar('_filter_2__T')  # <T>
    @classmethod
    @overload
    def filter(cls, list: java.util.List[_filter_2__T]) -> 'Filters.FilterSourceCollectionHolder'[_filter_2__T, java.util.List[_filter_2__T]]: ...
...
class Mappers:
    ...
    @classmethod
    @overload
    def group(cls, list: java.util.List[_group_0__S]) -> 'Mappers.GroupSourceCollectionHolder'[_group_0__S, java.util.List[_group_0__S]]: ...
    _group_1__S = _py_TypeVar('_group_1__S')  # <S>
    @classmethod
    @overload
    def group(cls, collection: java.util.Collection[_group_1__S]) -> 'Mappers.GroupSourceCollectionHolder'[_group_1__S, java.util.Collection[_group_1__S]]: ...
