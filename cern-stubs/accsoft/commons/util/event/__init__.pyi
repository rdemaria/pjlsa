...
class SyncEventListenerSupport(EventListenerSupport[_SyncEventListenerSupport__T], _py_Generic[_SyncEventListenerSupport__T]):
    ...
    @classmethod
    @overload
    def newInstance(cls, class_: _py_Type[_newInstance_0__T]) -> 'SyncEventListenerSupport'[_newInstance_0__T]: ...
    _newInstance_1__T = _py_TypeVar('_newInstance_1__T')  # <T>
    @classmethod
    @overload
    def newInstance(cls, class_: _py_Type[_newInstance_1__T]) -> EventListenerSupport[_newInstance_1__T]: ...
