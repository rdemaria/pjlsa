...
class Either(_py_Generic[_Either__L, _Either__R]):
    ...
    _left_0__L = _py_TypeVar('_left_0__L')  # <L>
    _left_0__R = _py_TypeVar('_left_0__R')  # <R>
    @classmethod
    @overload
    def left(cls, l: _left_0__L) -> 'Either'[_left_0__L, _left_0__R]: ...
    @overload
...
class FailSafe(_py_Generic[_FailSafe__E, _FailSafe__T]):
    ...
    @classmethod
    @overload
    def of(cls, t: _of_0__T) -> 'FailSafe'[_of_0__E, _of_0__T]: ...
    _of_1__E = _py_TypeVar('_of_1__E', bound=java.lang.Exception)  # <E>
    _of_1__T = _py_TypeVar('_of_1__T')  # <T>
    @classmethod
    @overload
    def of(cls, e: _of_1__E) -> 'FailSafe'[_of_1__E, _of_1__T]: ...
...
class SerializablePair(Pair[_SerializablePair__E, _SerializablePair__T], java.io.Serializable, _py_Generic[_SerializablePair__E, _SerializablePair__T]):
    ...
    _newInstance_0__R = _py_TypeVar('_newInstance_0__R', bound=java.io.Serializable)  # <R>
    _newInstance_0__S = _py_TypeVar('_newInstance_0__S', bound=java.io.Serializable)  # <S>
    @classmethod
    @overload
    def newInstance(cls, r: _newInstance_0__R, s: _newInstance_0__S) -> 'SerializablePair'[_newInstance_0__R, _newInstance_0__S]: ...
    _newInstance_1__R = _py_TypeVar('_newInstance_1__R')  # <R>
    _newInstance_1__S = _py_TypeVar('_newInstance_1__S')  # <S>
    @classmethod
    @overload
    def newInstance(cls, r: _newInstance_1__R, s: _newInstance_1__S) -> Pair[_newInstance_1__R, _newInstance_1__S]: ...
