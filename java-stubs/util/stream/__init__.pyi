...
class Collector(_py_Generic[_Collector__T, _Collector__A, _Collector__R]):
    ...
    @classmethod
    @overload
    def of(cls, supplier: java.util.function.Supplier[_of_0__R], biConsumer: java.util.function.BiConsumer[_of_0__R, _of_0__T], binaryOperator: java.util.function.BinaryOperator[_of_0__R], characteristicsArray: _py_List['Collector.Characteristics']) -> 'Collector'[_of_0__T, _of_0__R, _of_0__R]: ...
    _of_1__T = _py_TypeVar('_of_1__T')  # <T>
    _of_1__A = _py_TypeVar('_of_1__A')  # <A>
    _of_1__R = _py_TypeVar('_of_1__R')  # <R>
    @classmethod
    @overload
    def of(cls, supplier: java.util.function.Supplier[_of_1__A], biConsumer: java.util.function.BiConsumer[_of_1__A, _of_1__T], binaryOperator: java.util.function.BinaryOperator[_of_1__A], function: java.util.function.Function[_of_1__A, _of_1__R], characteristicsArray: _py_List['Collector.Characteristics']) -> 'Collector'[_of_1__T, _of_1__A, _of_1__R]: ...
...
class Collectors:
    ...
    _groupingBy_0__A = _py_TypeVar('_groupingBy_0__A')  # <A>
    _groupingBy_0__D = _py_TypeVar('_groupingBy_0__D')  # <D>
    @classmethod
    @overload
    def groupingBy(cls, function: java.util.function.Function[_groupingBy_0__T, _groupingBy_0__K], collector: Collector[_groupingBy_0__T, _groupingBy_0__A, _groupingBy_0__D]) -> Collector[_groupingBy_0__T, _py_Any, java.util.Map[_groupingBy_0__K, _groupingBy_0__D]]: ...
    _groupingBy_1__T = _py_TypeVar('_groupingBy_1__T')  # <T>
    _groupingBy_1__K = _py_TypeVar('_groupingBy_1__K')  # <K>
    @classmethod
    @overload
    def groupingBy(cls, function: java.util.function.Function[_groupingBy_1__T, _groupingBy_1__K]) -> Collector[_groupingBy_1__T, _py_Any, java.util.Map[_groupingBy_1__K, java.util.List[_groupingBy_1__T]]]: ...
    ...
    _groupingBy_2__M = _py_TypeVar('_groupingBy_2__M', bound=java.util.Map)  # <M>
    @classmethod
    @overload
    def groupingBy(cls, function: java.util.function.Function[_groupingBy_2__T, _groupingBy_2__K], supplier: java.util.function.Supplier[_groupingBy_2__M], collector: Collector[_groupingBy_2__T, _groupingBy_2__A, _groupingBy_2__D]) -> Collector[_groupingBy_2__T, _py_Any, _groupingBy_2__M]: ...
    ...
    _groupingByConcurrent_0__A = _py_TypeVar('_groupingByConcurrent_0__A')  # <A>
    _groupingByConcurrent_0__D = _py_TypeVar('_groupingByConcurrent_0__D')  # <D>
    @classmethod
    @overload
    def groupingByConcurrent(cls, function: java.util.function.Function[_groupingByConcurrent_0__T, _groupingByConcurrent_0__K], collector: Collector[_groupingByConcurrent_0__T, _groupingByConcurrent_0__A, _groupingByConcurrent_0__D]) -> Collector[_groupingByConcurrent_0__T, _py_Any, java.util.concurrent.ConcurrentMap[_groupingByConcurrent_0__K, _groupingByConcurrent_0__D]]: ...
    ...
    @classmethod
    @overload
    def groupingByConcurrent(cls, function: java.util.function.Function[_groupingByConcurrent_2__T, _groupingByConcurrent_2__K]) -> Collector[_groupingByConcurrent_2__T, _py_Any, java.util.concurrent.ConcurrentMap[_groupingByConcurrent_2__K, java.util.List[_groupingByConcurrent_2__T]]]: ...
    @classmethod
    @overload
    ...
    _toMap_0__M = _py_TypeVar('_toMap_0__M', bound=java.util.Map)  # <M>
    @classmethod
    @overload
    def toMap(cls, function: java.util.function.Function[_toMap_0__T, _toMap_0__K], function2: java.util.function.Function[_toMap_0__T, _toMap_0__U], binaryOperator: java.util.function.BinaryOperator[_toMap_0__U], supplier: java.util.function.Supplier[_toMap_0__M]) -> Collector[_toMap_0__T, _py_Any, _toMap_0__M]: ...
    _toMap_1__T = _py_TypeVar('_toMap_1__T')  # <T>
    _toMap_1__K = _py_TypeVar('_toMap_1__K')  # <K>
    _toMap_1__U = _py_TypeVar('_toMap_1__U')  # <U>
    @classmethod
    @overload
    def toMap(cls, function: java.util.function.Function[_toMap_1__T, _toMap_1__K], function2: java.util.function.Function[_toMap_1__T, _toMap_1__U]) -> Collector[_toMap_1__T, _py_Any, java.util.Map[_toMap_1__K, _toMap_1__U]]: ...
    _toMap_2__T = _py_TypeVar('_toMap_2__T')  # <T>
    _toMap_2__K = _py_TypeVar('_toMap_2__K')  # <K>
    _toMap_2__U = _py_TypeVar('_toMap_2__U')  # <U>
    @classmethod
    @overload
    def toMap(cls, function: java.util.function.Function[_toMap_2__T, _toMap_2__K], function2: java.util.function.Function[_toMap_2__T, _toMap_2__U], binaryOperator: java.util.function.BinaryOperator[_toMap_2__U]) -> Collector[_toMap_2__T, _py_Any, java.util.Map[_toMap_2__K, _toMap_2__U]]: ...
...
class ReduceOps:
    ...
    _makeLong_0__R = _py_TypeVar('_makeLong_0__R')  # <R>
    @classmethod
    @overload
    def makeLong(cls, supplier: java.util.function.Supplier[_makeLong_0__R], objLongConsumer: java.util.function.ObjLongConsumer[_makeLong_0__R], binaryOperator: java.util.function.BinaryOperator[_makeLong_0__R]) -> 'TerminalOp'[int, _makeLong_0__R]: ...
    @classmethod
    @overload
    ...
    _makeRef_0__R = _py_TypeVar('_makeRef_0__R')  # <R>
    @classmethod
    @overload
    def makeRef(cls, supplier: java.util.function.Supplier[_makeRef_0__R], biConsumer: java.util.function.BiConsumer[_makeRef_0__R, _makeRef_0__T], biConsumer2: java.util.function.BiConsumer[_makeRef_0__R, _makeRef_0__R]) -> 'TerminalOp'[_makeRef_0__T, _makeRef_0__R]: ...
    _makeRef_1__T = _py_TypeVar('_makeRef_1__T')  # <T>
    _makeRef_1__U = _py_TypeVar('_makeRef_1__U')  # <U>
    @classmethod
    @overload
    def makeRef(cls, u: _makeRef_1__U, biFunction: java.util.function.BiFunction[_makeRef_1__U, _makeRef_1__T, _makeRef_1__U], binaryOperator: java.util.function.BinaryOperator[_makeRef_1__U]) -> 'TerminalOp'[_makeRef_1__T, _makeRef_1__U]: ...
    _makeRef_2__T = _py_TypeVar('_makeRef_2__T')  # <T>
    @classmethod
    @overload
    def makeRef(cls, binaryOperator: java.util.function.BinaryOperator[_makeRef_2__T]) -> 'TerminalOp'[_makeRef_2__T, java.util.Optional[_makeRef_2__T]]: ...
...
class StreamSupport:
    ...
    @classmethod
    @overload
    def stream(cls, supplier: java.util.function.Supplier[java.util.Spliterator[_stream_0__T]], int: int, boolean: bool) -> 'Stream'[_stream_0__T]: ...
    _stream_1__T = _py_TypeVar('_stream_1__T')  # <T>
    @classmethod
    @overload
    def stream(cls, spliterator: java.util.Spliterator[_stream_1__T], boolean: bool) -> 'Stream'[_stream_1__T]: ...
...
class Stream(BaseStream[_Stream__T, 'Stream'[_Stream__T]], _py_Generic[_Stream__T]):
    ...
    _collect_0__A = _py_TypeVar('_collect_0__A')  # <A>
    @overload
    def collect(self, collector: Collector[_Stream__T, _collect_0__A, _collect_0__R]) -> _collect_0__R: ...
    _collect_1__R = _py_TypeVar('_collect_1__R')  # <R>
    @overload
    def collect(self, supplier: java.util.function.Supplier[_collect_1__R], biConsumer: java.util.function.BiConsumer[_collect_1__R, _Stream__T], biConsumer2: java.util.function.BiConsumer[_collect_1__R, _collect_1__R]) -> _collect_1__R: ...
    ...
    @classmethod
    @overload
    def of(cls, tArray: _py_List[_of_0__T]) -> 'Stream'[_of_0__T]: ...
    _of_1__T = _py_TypeVar('_of_1__T')  # <T>
    @classmethod
    @overload
    def of(cls, t: _of_1__T) -> 'Stream'[_of_1__T]: ...
    ...
    _reduce_2__U = _py_TypeVar('_reduce_2__U')  # <U>
    @overload
    def reduce(self, u: _reduce_2__U, biFunction: java.util.function.BiFunction[_reduce_2__U, _Stream__T, _reduce_2__U], binaryOperator: java.util.function.BinaryOperator[_reduce_2__U]) -> _reduce_2__U: ...
    ...
    _toArray_0__A = _py_TypeVar('_toArray_0__A')  # <A>
    @overload
    def toArray(self, intFunction: java.util.function.IntFunction[_py_List[_toArray_0__A]]) -> _py_List[_toArray_0__A]: ...
    @overload
...
class ReferencePipeline(AbstractPipeline[_ReferencePipeline__P_IN, _ReferencePipeline__P_OUT, Stream[_ReferencePipeline__P_OUT]], Stream[_ReferencePipeline__P_OUT], _py_Generic[_ReferencePipeline__P_IN, _ReferencePipeline__P_OUT]):
    ...
    _reduce_1__R = _py_TypeVar('_reduce_1__R')  # <R>
    @overload
    def reduce(self, r: _reduce_1__R, biFunction: java.util.function.BiFunction[_reduce_1__R, _ReferencePipeline__P_OUT, _reduce_1__R], binaryOperator: java.util.function.BinaryOperator[_reduce_1__R]) -> _reduce_1__R: ...
    @overload
