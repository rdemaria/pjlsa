...
class AccessController:
    ...
    @classmethod
    @overload
    def doPrivileged(cls, privilegedExceptionAction: 'PrivilegedExceptionAction'[_doPrivileged_0__T], accessControlContext: AccessControlContext, permissionArray: _py_List['Permission']) -> _doPrivileged_0__T: ...
    _doPrivileged_1__T = _py_TypeVar('_doPrivileged_1__T')  # <T>
    @classmethod
    @overload
    def doPrivileged(cls, privilegedExceptionAction: 'PrivilegedExceptionAction'[_doPrivileged_1__T]) -> _doPrivileged_1__T: ...
    ...
    @classmethod
    @overload
    def doPrivileged(cls, privilegedExceptionAction: 'PrivilegedExceptionAction'[_doPrivileged_3__T], accessControlContext: AccessControlContext) -> _doPrivileged_3__T: ...
    _doPrivileged_4__T = _py_TypeVar('_doPrivileged_4__T')  # <T>
    @classmethod
    @overload
    def doPrivileged(cls, privilegedAction: 'PrivilegedAction'[_doPrivileged_4__T], accessControlContext: AccessControlContext) -> _doPrivileged_4__T: ...
    _doPrivileged_5__T = _py_TypeVar('_doPrivileged_5__T')  # <T>
    @classmethod
    @overload
    def doPrivileged(cls, privilegedAction: 'PrivilegedAction'[_doPrivileged_5__T], accessControlContext: AccessControlContext, permissionArray: _py_List['Permission']) -> _doPrivileged_5__T: ...
    _doPrivilegedWithCombiner_0__T = _py_TypeVar('_doPrivilegedWithCombiner_0__T')  # <T>
    @classmethod
    @overload
    def doPrivilegedWithCombiner(cls, privilegedExceptionAction: 'PrivilegedExceptionAction'[_doPrivilegedWithCombiner_0__T], accessControlContext: AccessControlContext, permissionArray: _py_List['Permission']) -> _doPrivilegedWithCombiner_0__T: ...
    ...
    @classmethod
    @overload
    def doPrivilegedWithCombiner(cls, privilegedAction: 'PrivilegedAction'[_doPrivilegedWithCombiner_3__T]) -> _doPrivilegedWithCombiner_3__T: ...
    @classmethod
