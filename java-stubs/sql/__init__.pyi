...
class SQLInput:
    ...
    _readObject_0__T = _py_TypeVar('_readObject_0__T')  # <T>
    @overload
    def readObject(self, class_: _py_Type[_readObject_0__T]) -> _readObject_0__T: ...
    @overload
...
class ResultSet(Wrapper, java.lang.AutoCloseable):
    ...
    _getObject_5__T = _py_TypeVar('_getObject_5__T')  # <T>
    @overload
    def getObject(self, int: int, class_: _py_Type[_getObject_5__T]) -> _getObject_5__T: ...
    @overload
...
class CallableStatement(PreparedStatement):
    ...
    @overload
    def getObject(self, string: str, map: java.util.Map[str, _py_Type[_py_Any]]) -> _py_Any: ...
    _getObject_3__T = _py_TypeVar('_getObject_3__T')  # <T>
    @overload
    def getObject(self, string: str, class_: _py_Type[_getObject_3__T]) -> _getObject_3__T: ...
    @overload
    def getObject(self, int: int, map: java.util.Map[str, _py_Type[_py_Any]]) -> _py_Any: ...
    _getObject_5__T = _py_TypeVar('_getObject_5__T')  # <T>
    @overload
